						...
						<label><textarea type="text" rows="15" cols="86" id="extend_contents" name="extend_contents"><?php echo isset($this->_var['EXTEND_CONTENTS']) ? $this->_var['EXTEND_CONTENTS'] : ''; ?></textarea> </label>
					<br />
					...
					<dl>
						...
						<dd>
							<label><input type="radio" value="1" name="archive" /> <?php echo isset($this->_var['L_YES']) ? $this->_var['L_YES'] : ''; ?></label>
							<label><input type="radio" value="0" name="archive" id="archive" checked="checked" /> <?php echo isset($this->_var['L_NO']) ? $this->_var['L_NO'] : ''; ?></label>
						</dd>
					</dl>
				</fieldset>	
				...
				<fieldset>
					...
					<dl>
						...
						<dd><label><input type="text" size="60" id="img_field" name="img" value="<?php echo isset($this->_var['IMG']) ? $this->_var['IMG'] : ''; ?>" class="text" /></label></dd>
					</dl>
					<dl>
						<dt><label for="alt"><?php echo isset($this->_var['L_IMG_DESC']) ? $this->_var['L_IMG_DESC'] : ''; ?></label></dt>
						<dd><label><input type="text" size="60" name="alt" id="alt" value="<?php echo isset($this->_var['ALT']) ? $this->_var['ALT'] : ''; ?>" class="text" /></label></dd>
					</dl>
				</fieldset>		
