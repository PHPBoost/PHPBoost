...
GoogleMapsFormFieldMultipleMarkers.prototype = {
	add : function () {
		if (this.integer <= this.max_input) {
			...
			jQuery('<div/>', {id : 'field-' + id, class: 'grouped-inputs inputs-with-button map-input-container'}).appendTo('#marker-' + id);
...
# START fieldelements #
	<div id="marker-${escape(HTML_ID)}-{fieldelements.ID}" class="marker-container">
		<div class="grouped-inputs inputs-with-button map-input-container" id="field-${escape(HTML_ID)}-{fieldelements.ID} map-input-container">
