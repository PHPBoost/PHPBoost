...
class WebLink
{
	...
	public function get_real_short_contents()
	{
		...
		return TextHelper::mb_substr(@strip_tags(FormatingHelper::second_parse($this->contents), '<br><br/>'), 0, (int)WebConfig::NUMBER_CARACTERS_BEFORE_CUT);
	}
	...
	public function get_array_tpl_vars()
	{
		...
		return array_merge(
			...
			'C_READ_MORE' => !$this->is_short_contents_enabled() && $description != @strip_tags($contents, '<br><br/>') && TextHelper::strlen($description) > WebConfig::NUMBER_CARACTERS_BEFORE_CUT,
