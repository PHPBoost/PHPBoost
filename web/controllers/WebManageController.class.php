...
class WebManageController extends AdminModuleController
{
	...
	private function build_table()
	{
		...
		foreach ($result as $row)
		{
			...
			$edit_link = new LinkHTMLElement(WebUrlBuilder::edit($weblink->get_id()), '', array('title' => LangLoader::get_message('edit', 'common')), 'far fa-edit');
			$delete_link = new LinkHTMLElement(WebUrlBuilder::delete($weblink->get_id()), '', array('title' => LangLoader::get_message('delete', 'common'), 'data-confirmation' => 'delete-element'), 'far fa-delete');
