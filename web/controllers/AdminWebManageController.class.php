...
class AdminWebManageController extends AdminModuleController
{
	...
	private function build_table()
	{
		...
		foreach ($result as $row)
		{
			...
			$edit_Link = new LinkHTMLElement(WebUrlBuilder::edit($weblink->get_id(), SITE_REWRITED_SCRIPT), '', array('title' => LangLoader::get_message('edit', 'common')), 'fa fa-edit');
			$delete_link = new LinkHTMLElement(WebUrlBuilder::delete($weblink->get_id(), SITE_REWRITED_SCRIPT), '', array('title' => LangLoader::get_message('delete', 'common'), 'data-confirmation' => 'delete-element'), 'fa fa-delete');
			...
			$results[] = new HTMLTableRow(array(
				...
				new HTMLTableRowCell(new LinkHTMLElement(WebUrlBuilder::display($category->get_id(), $category->get_rewrited_name(), $weblink->get_id(), $weblink->get_rewrited_name()), $weblink->get_name())),
