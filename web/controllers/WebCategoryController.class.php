...
class WebCategoryController extends ModuleController
{
	...
	private function build_sorting_form($field, $mode)
	{
		...
		$sort_options = array(
			new FormFieldSelectChoiceOption($common_lang['form.date.creation'], WebItem::SORT_FIELDS_URL_VALUES[WebItem::SORT_DATE], array('data_option_icon' => 'far fa-calendar-alt')),
			new FormFieldSelectChoiceOption($common_lang['form.name'], WebItem::SORT_FIELDS_URL_VALUES[WebItem::SORT_ALPHABETIC], array('data_option_icon' => 'fa fa-sort-alpha-up')),
