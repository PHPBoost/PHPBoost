<section id="module-web" class="several-items">
	<header class="section-header">
		<div class="controls align-right">
			# IF C_CATEGORY #<a class="offload" href="${relative_url(SyndicationUrlBuilder::rss('web', CATEGORY_ID))}" aria-label="{@common.syndication}"><i class="fa fa-rss warning" aria-hidden="true"></i></a># ENDIF #
