...
<ul class="formatter-ul">
	<li class="formatter-li"> Pour configurer ou personnaliser l\'accueil de votre module, rendez vous dans l\'<a href="' . WebUrlBuilder::configuration()->rel() . '">administration du module</a></li>
	<li class="formatter-li"> Pour créer des catégories, <a href="' . WebUrlBuilder::add_category()->rel() . '">cliquez ici</a> </li>
	<li class="formatter-li"> Pour ajouter des liens, <a href="' . WebUrlBuilder::add()->rel() . '">cliquez ici</a></li>
</ul>
