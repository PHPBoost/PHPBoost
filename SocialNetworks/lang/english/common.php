...
$lang['admin.menu.mini_module_message'] = 'To show share media links in mini-module, <br />enable the dedicated mini-module in <a href="' . PATH_TO_ROOT . '/admin/menus/menus.php">Menus configuration</a>.';
$lang['admin.menu.content_message'] = 'To show share media links in the content page, <br />enable this option in <a href="{PATH_TO_ROOT}/admin/content/config/">Content configuration</a>.';
