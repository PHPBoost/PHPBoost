...
class AdminThemesNotInstalledListController extends AdminController
{
	...
	private function upload_form()
	{
		...
		$fieldset->add_field(new FormFieldFree('warnings', '', $this->lang['themes.warning_before_install'], array('class' => 'full-field')));
		$fieldset->add_field(new FormFieldFilePicker('file', $this->lang['themes.upload_description'], array('class' => 'half-field', 'authorized_extensions' => 'gz|zip')));
