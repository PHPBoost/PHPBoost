...
$template->put_all(array(
	...
	'L_SERVER_URL' => LangLoader::get_message('advanced-config.site_url', 'admin-config-common'),
	'L_SITE_PATH' => LangLoader::get_message('advanced-config.site_path', 'admin-config-common'),
	'L_PHPBOOST_CONFIG' => $LANG['phpboost_config'],
	'L_KERNEL_VERSION' => $LANG['kernel_version'],
	'L_DEFAULT_THEME' => LangLoader::get_message('general-config.default_theme', 'admin-config-common'),
	'L_DEFAULT_LANG' => LangLoader::get_message('general-config.default_language', 'admin-config-common'),
	'L_DEFAULT_EDITOR' => LangLoader::get_message('content.config.default-formatting-language', 'admin-contents-common'),
	'L_START_PAGE' => LangLoader::get_message('general-config.start_page', 'admin-config-common'),
	'L_OUTPUT_GZ' => $LANG['output_gz'],
	'L_COOKIE_NAME' => LangLoader::get_message('advanced-config.cookie-name', 'admin-config-common'),
	'L_SESSION_LENGTH' => LangLoader::get_message('advanced-config.cookie-duration', 'admin-config-common'),
	'L_SESSION_GUEST_LENGTH' => LangLoader::get_message('advanced-config.active-session-duration', 'admin-config-common'),
