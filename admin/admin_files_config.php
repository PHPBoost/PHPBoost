...
if( !empty($_POST['valid'])  )
{
	...
	$config_files['size_limit'] = isset($_POST['size_limit']) ? number_round(numeric($_POST['size_limit'], 'float'), 1) * 1024 : 500;
...
{		
	...
	$template->assign_vars(array(
		...
		'SIZE_LIMIT' => isset($CONFIG_FILES['size_limit']) ? number_round($CONFIG_FILES['size_limit']/1024, 1) : '0.5',
