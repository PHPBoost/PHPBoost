...
elseif( !empty($_POST['valid']) )
{
	...
	$possible_values = !empty($_POST['possible_values']) ? securit($_POST['possible_values']) : '';
	$default_values = !empty($_POST['default_values']) ? securit($_POST['default_values']) : '';
	
	$regex_type = !empty($_POST['regex_type']) ? numeric($_POST['regex_type']) : '0';
	if( empty($regex_type) )
		$regex = !empty($_POST['regex1']) ? numeric($_POST['regex1']) : '0';
	else
		$regex = !empty($_POST['regex2']) ? securit($_POST['regex2']) : '';
