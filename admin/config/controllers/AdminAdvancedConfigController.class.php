...
class AdminAdvancedConfigController extends AdminController
{
	...
	private function build_form()
	{
		...
		$miscellaneous_fieldset->add_field(new FormFieldFree('unlock_administration', $this->lang['advanced-config.unlock-administration'], '<a href="'. $this->get_unlock_administration_url() .'">'. $this->lang['advanced-config.unlock-administration.request'] .'</a>', 
