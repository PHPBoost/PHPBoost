...
class AdminMembersDisplayResponse extends AdminMenuDisplayResponse
{
	public function __construct($view, $title_page)
	{
		...
		$this->add_link($lang['members.members-management'], TPL_PATH_TO_ROOT . '/admin/admin_members.php', $picture);
		...
		$this->add_link($lang['members.members-punishment'], TPL_PATH_TO_ROOT . '/admin/admin_members_punishment.php', $picture);
