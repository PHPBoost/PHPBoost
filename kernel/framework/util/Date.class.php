...
class Date
{
	...
	{
		$this->compute_server_user_difference($timezone);
		return Texthelper::uppercase_first(TextHelper::substr(self::transform_date($this->date_time->format('F')), 0, $characters_number));
	}
	...
	{
		$this->compute_server_user_difference($timezone);
		return Texthelper::uppercase_first(TextHelper::substr(self::transform_date($this->date_time->format('l')), 0, $characters_number));
	}
