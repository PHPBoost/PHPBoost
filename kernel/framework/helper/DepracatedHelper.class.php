...
class DeprecatedHelper {
	 ...
	 */
	public static function retrieve($var_type, $var_name, $default_value, $force_type = NULL, $flags = 0)
	{
		$var = null;
		switch ($var_type)
		{
	 ...
	 */
	public static function get_ini_config($dir_path, $require_dir, $ini_name = 'config.ini')
	{
	 ...
	 * @see Date::format()
	 */
	public static function gmdate_format($format, $timestamp = false, $timezone_system = 0)
	{
	 ...
	 * @see Date::Date()
	 */
	public static function strtotimestamp($str, $date_format)
	{
		global $CONFIG, $User;
	 ...
	 * @return string The formatted date
	 */
	public static function strtodate($str, $date_format)
	{
		list($month, $day, $year) = array(0, 0, 0);
