...
class NotationService
{
	...
	public static function display_active_image(Notation $notation)
	{
		...
		else
		{
			...
			$average_notes = (string) $notation->get_average_notes() != '' ? $notation->get_average_notes() : self::get_average_notes($notation);
			...
			$count_notes = (string) $notation->get_number_notes() != '' ? $notation->get_number_notes() : NotationService::get_number_notes($notation);
			...
			$template->put_all(array(
				...
				'ALREADY_NOTE' => (string) $notation->get_current_user_note() != '' ? $notation->get_current_user_note() : NotationDAO::get_member_already_notation($notation),
