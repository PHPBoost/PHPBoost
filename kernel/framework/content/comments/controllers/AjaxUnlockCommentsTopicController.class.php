<?php
/*##################################################
 *                       AjaxUnlockCommentsTopicControlle.class.php
 *                            -------------------
...
class AjaxUnlockCommentsTopicControlle extends AbstractCommentsController
{
	public function execute(HTTPRequest $request)
	{
		...
		{
			CommentsManager::unlock_topic($this->module_id, $this->id_in_module);
		...
		else
		{
			$object = array(
				'success' => false,
				'message' => $comments_lang['comment.unlock.not-authorized']
			);
		}
