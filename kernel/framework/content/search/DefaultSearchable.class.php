	...
	public function get_search_request($args)
	{
		...
		if ($this->read_authorization !== false)
		{
			return "SELECT " . $args['id_search'] . " AS id_search,
				...
				( 2 * FT_SEARCH_RELEVANCE(" . $table_label . "." . $this->field_title . ", '" . $args['search'] . "') + (FT_SEARCH_RELEVANCE(" . $table_label . "." . $this->field_contents . ", '" . $args['search'] . "')" . ($this->has_short_contents ? " +
				FT_SEARCH_RELEVANCE(" . $table_label . "." . $this->field_short_contents . ", '" . $args['search'] . "')) / 2 " : ")") . ") / 3 * " . $weight . " AS relevance,
				...
				WHERE ( FT_SEARCH(" . $table_label . "." . $this->field_title . ", '" . $args['search'] . "') OR FT_SEARCH(" . $table_label . "." . $this->field_contents . ", '" . $args['search'] . "')" . ($this->has_short_contents ? " OR FT_SEARCH_RELEVANCE(" . $table_label . "." . $this->field_short_contents . ", '" . $args['search'] . "')" : "") . " )" . ($this->use_keywords ? " OR keyword.rewrited_name = '" . Url::encode_rewrite($args['search']) . "'" : "") . "
