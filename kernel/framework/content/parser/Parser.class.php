...
abstract class Parser
{
	 ...
	 * @param bool $addslashes Parser::ADD_SLASHES if you want to escape the slashes in your string
	 * (you often save a parsed content into the database when you parse it), otherwise Parser::DONT_ADD_SLASHES.
	 * @return string The content of the parser.
	 */
	public function get_content($addslashes = Parser::ADD_SLASHES)
	{
		if ($addslashes)
		{
	 ...
	 * @param bool $stripslashes Parser::DONT_STRIP_SLASHES if you don't want to strip slashes before adding it to the parser,
	 * otherwise Parser::STRIP_SLASHES.
	 */
	public function set_content($content, $stripslashes = Parser::DONT_STRIP_SLASHES)
	{
		if ($stripslashes)
		{
