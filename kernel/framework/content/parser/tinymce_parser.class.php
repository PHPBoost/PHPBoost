...
class TinyMCEParser extends ContentParser
{
	...
	function _parse_tinymce_formatting()
	{
		...
		{
		    //TinyMCE a un comportement un peu spï¿½cial avec la gestion des polices, il les imbrique les unes dans les autres de faï¿½on pas trï¿½s logique
		    //Tant qu'il existe des occurences de cette balise ï¿½ travailler, on les traite
		    //Sï¿½curitï¿½ : on traite au maximum 10 fois pour ï¿½viter les boucles infinies ï¿½ventuelles
		    $nbr_font_parsing = 0;
	...
	function _parse_bbcode_tags()
	{
		...
		##Parsage des balises imbriquï¿½es.
		//Texte cachï¿½
		...
		//Liens vers des articles de Wikipï¿½dia
