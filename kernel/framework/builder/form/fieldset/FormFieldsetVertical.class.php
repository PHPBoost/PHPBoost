...
{
    private static $tpl_src = '<div class="vertical_fieldset" id="{E_ID}" # IF C_HIDDEN # style="display:none;" # ENDIF #># IF C_DESCRIPTION #<p>{E_DESCRIPTION}</p># ENDIF ## START fields # # INCLUDE fields.FIELD # # END fields #</div>';
