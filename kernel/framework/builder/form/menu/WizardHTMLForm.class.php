<?php
/**
 * This class is a fork of HTMLForms for a wizard menu and enables you to handle all the operations regarding forms.
...
class WizardHTMLForm implements HTMLElement
{
	...
	private function add_catpcha_protection()
	{
		...
		$captcha_protection_fieldset->set_css_class('captcha-element wizard-step');
	...
	public function display()
	{
		...
		{
			$buttons_fieldset = new WizardFormFieldsetSubmit('fbuttons');
