<?php
/*##################################################
 *                               MemberUserTimezoneExtendedField.class.php
 *                            -------------------
...
class MemberUserTimezoneExtendedField extends AbstractMemberExtendedField
{
	public function __construct()
	{
		parent::__construct();
		$this->set_disable_fields_configuration(array('regex', 'possible_values', 'default_values'));
		$this->set_name(LangLoader::get_message('type.user-timezone','admin-extended-fields-common'));
