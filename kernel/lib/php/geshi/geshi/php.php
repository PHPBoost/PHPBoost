...
$language_data = array(
    ...
    'KEYWORDS' => array(
        1 => array(
            'abstract','as','break','case','class','const','continue','declare',
            'default','do','echo','else','elseif','endfor','endforeach','endif',
            'endswitch','endwhile','extends','function','for','foreach','global',
            'if','include','include_once','interface','namespace','new','print',
            'private','protected','public','require','require_once','return','self',
            'switch','throw','use','var','while'
            ),
        2 => array(
    ...
    'STYLES' => array(
        'KEYWORDS' => array(
            ...
            2 => 'color: #FF0000; font-weight: normal;',
        ...
        'COMMENTS' => array(
            ...
            4 => 'color: #008000; font-style: italic;',
