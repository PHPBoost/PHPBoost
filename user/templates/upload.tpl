...
<section id="module-user-upload" class="user-upload-files">
	...
	<div class="sub-section">
		<div class="content-container">
			<div class="content">
				<div id="upload-box" class="tabs-container">
					<nav class="tabs-nav">
						<ul class="tabs-items">
							<li><a href="#" class="tab-item --upload-personal">{@upload.personal.files}</a></li>
							<li><a href="#" class="tab-item --upload-shared">{@upload.shared.files}</a></li>
						</ul>
					</nav>
                    <div class="tabs-wrapper">
                        <div id="upload-personal" class="tab-content">
                        ...
                        <div id="upload-shared" class="tab-content">
                            # IF C_SHARED_FILES #
                                <div class="cell-flex cell-tile # IF C_POPUP #cell-inline# ELSE #cell-columns-4# ENDIF #">
                                    # START shared_files #
