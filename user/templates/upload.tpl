							...
							<tr>
								...
								<td style="padding-top:8px;">						
									...
									<div style="padding-top:5px;">
										...
										<a href="upload{folder.U_MOVE}" title="{L_MOVETO}" class="icon-forward"></a>
						...
						<table class="module_table mini" style="border:0;">
							<tr>
								...
								<td style="padding-top:8px;">	
									...
									<a href="upload{files.U_MOVE}" title="{L_MOVETO}" class="icon-forward"></a>								
