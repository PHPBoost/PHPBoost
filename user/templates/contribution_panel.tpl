					...
					<tr>
						...
						<th>
							# IF NOT C_ORDER_MODULE_ASC #
								<a href="{U_ORDER_MODULE_ASC}" class="sort-up"></a>
							# ENDIF #
							{L_MODULE}
							# IF NOT C_ORDER_MODULE_DESC #
								<a href="{U_ORDER_MODULE_DESC}" class="sort-down"></a>
							# ENDIF #
						</th>
						<th>
						...
						<th>
							# IF NOT C_ORDER_FIXING_DATE_ASC #
								<a href="{U_ORDER_FIXING_DATE_ASC}" class="sort-up"></a>
							# ENDIF #
							{L_FIXING_DATE}
							# IF NOT C_ORDER_FIXING_DATE_DESC #
								<a href="{U_ORDER_FIXING_DATE_DESC}" class="sort-down"></a>
							# ENDIF #
						</th>
						<th>
							# IF NOT C_ORDER_POSTER_ASC #
								<a href="{U_ORDER_POSTER_ASC}" class="sort-up"></a>
							# ENDIF #
							{L_POSTER}
							# IF NOT C_ORDER_POSTER_DESC #
								<a href="{U_ORDER_POSTER_DESC}" class="sort-down"></a>
							# ENDIF #
						</th>
						<th>
							# IF NOT C_ORDER_FIXER_ASC #
								<a href="{U_ORDER_FIXER_ASC}" class="sort-up"></a>
							# ENDIF #
							{L_FIXER}
							# IF NOT C_ORDER_FIXER_DESC #
								<a href="{U_ORDER_FIXER_DESC}" class="sort-down"></a>
							# ENDIF #
						</th>
					</tr>
				</thead>
