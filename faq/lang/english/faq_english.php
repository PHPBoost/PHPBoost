...
$FAQ_LANG['display_inline'] = 'In line';
$FAQ_LANG['display_auto'] = 'Automatic';
$FAQ_LANG['display_explain'] = 'In "Automatic" mode, the display will follow general configuration, in  "In line" mode answers will be hided and a click in the question will show its answer. In "In blocks" mode, answers will be after the questions.';
...
$FAQ_LANG['nbr_cols'] = 'Number of categories per line';
$FAQ_LANG['nbr_cols_explain'] = 'This number is the number of cols in which will be displayed the subcategories of a category';
$FAQ_LANG['display_mode_admin_explain'] = 'You can choose the way of the questions are displayed. "In lines" mode shows questions and, with a click in the question, the answer. "In blocks" mode shows all questions and questions answer. It\'s possible to choose display mode for each category. It\'s only the default configuration here.';
