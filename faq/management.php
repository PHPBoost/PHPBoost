...
elseif ($id_move > 0)
{
	...
	$Template->assign_block_vars('move_question', array(
		'CATEGORIES_TREE' => $faq_cats->build_select_form(0, 'target', 'target', 0, FaqAuthorizationsService::WRITE_AUTHORIZATIONS, $faq_config->get_authorizations(), IGNORE_AND_CONTINUE_BROWSING_IF_A_CATEGORY_DOES_NOT_MATCH),
		'ID_QUESTION' => $id_move
	));
	$Template->put_all(array(
...
else
{
	...
	$Template->assign_block_vars('category', array(
		'READ_AUTH' => 	Authorizations::generate_select(FaqAuthorizationsService::READ_AUTHORIZATIONS, !empty($FAQ_CATS[$id_faq]['auth']) ? $FAQ_CATS[$id_faq]['auth'] : $faq_config->get_authorizations()),
		'WRITE_AUTH' => Authorizations::generate_select(FaqAuthorizationsService::WRITE_AUTHORIZATIONS, !empty($FAQ_CATS[$id_faq]['auth']) ? $FAQ_CATS[$id_faq]['auth'] : $faq_config->get_authorizations()),
