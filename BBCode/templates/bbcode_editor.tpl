	...
	<nav class="bbcode-containers">
		<ul class="bbcode-groups">
			<li class="bbcode-group bbcode-text">
				<span class="bbcode-group-title bbcode-button" aria-label="{@bbcode.format}"><i class="fa fa-fw fa-font" aria-hidden="true"></i></span>
				<ul class="bbcode-container modal-container cell-modal cell-tile">
					<li id="format-bold" class="bbcode-elements">
						<span class="bbcode-button{AUTH_B} close-bbcode-sub" # IF NOT C_DISABLED_B #onclick="insertbbcode('[b]', '[/b]', '{FIELD}');"# ENDIF # role="button" aria-label="{@bbcode.bold}">
							<i class="fa fa-fw fa-bold" aria-hidden="true"></i>
						</span>
					</li>
					<li id="format-italic" class="bbcode-elements">
						<span class="bbcode-button{AUTH_I} close-bbcode-sub" # IF NOT C_DISABLED_I #onclick="insertbbcode('[i]', '[/i]', '{FIELD}');"# ENDIF # role="button" aria-label="{@bbcode.italic}">
							<i class="fa fa-fw fa-italic" aria-hidden="true"></i>
						</span>
					</li>
					<li id="format-underline" class="bbcode-elements">
						<span class="bbcode-button{AUTH_U} close-bbcode-sub" # IF NOT C_DISABLED_U #onclick="insertbbcode('[u]', '[/u]', '{FIELD}');"# ENDIF # role="button" aria-label="{@bbcode.underline}">
							<i class="fa fa-fw fa-underline" aria-hidden="true"></i>
						</span>
					</li>
					<li id="format-strike" class="bbcode-elements">
						<span class="bbcode-button{AUTH_S} close-bbcode-sub" # IF NOT C_DISABLED_S #onclick="insertbbcode('[s]', '[/s]', '{FIELD}');"# ENDIF # role="button" aria-label="{@bbcode.strike}">
						...
						<div id="block-size{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_size('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
						...
						<div id="block-font{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<nav class="cell-list cell-list-inline">
									<ul>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=andale mono]', '[/font]', '{FIELD}');"> <span style="font-family: andale mono;">Andale Mono</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=arial]', '[/font]', '{FIELD}');"> <span style="font-family: arial;">Arial</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=arial black]', '[/font]', '{FIELD}');"> <span style="font-family: arial black;">Arial Black</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=book antiqua]', '[/font]', '{FIELD}');"> <span style="font-family: book antiqua;">Book Antiqua</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=comic sans ms]', '[/font]', '{FIELD}');"> <span style="font-family: comic sans ms;">Comic Sans MS</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=courier new]', '[/font]', '{FIELD}');"> <span style="font-family: courier new;">Courier New</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=georgia]', '[/font]', '{FIELD}');"> <span style="font-family: georgia;">Georgia</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=helvetica]', '[/font]', '{FIELD}');"> <span style="font-family: helvetica;">Helvetica</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=impact]', '[/font]', '{FIELD}');"> <span style="font-family: impact;">Impact</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=symbol]', '[/font]', '{FIELD}');"> <span style="font-family: symbol;">Symbol</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=tahoma]', '[/font]', '{FIELD}');"> <span style="font-family: tahoma;">Tahoma</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=terminal]', '[/font]', '{FIELD}');"> <span style="font-family: terminal;">Terminal</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=times new roman]', '[/font]', '{FIELD}');"> <span style="font-family: times new roman;">Times New Roman</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=trebuchet ms]', '[/font]', '{FIELD}');"> <span style="font-family: trebuchet ms;">Trebuchet MS</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=verdana]', '[/font]', '{FIELD}');"> <span style="font-family: verdana;">Verdana</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=webdings]', '[/font]', '{FIELD}');"> <span style="font-family: webdings;">Webdings</span></li>
										<li class="hide-modal close-bbcode-sub" onclick="insertbbcode('[font=wingdings]', '[/font]', '{FIELD}');"> <span style="font-family: wingdings;">Wingdings</span></li>
									</ul>
								</nav>
							</div>
						</div>
			...
			<li class="bbcode-group bbcode-format">
				<span class="bbcode-group-title bbcode-button" aria-label="{@bbcode.layout}"><i class="fa fa-fw fa-table-columns" aria-hidden="true"></i></span>
				<ul class="bbcode-container modal-container cell-modal cell-tile">
						...
						<div id="block-align{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<nav class="cell-list">
									<ul>
										<li class="li-stretch">
											<span class=""><i class="fa fa-fw fa-align-left"></i> {@bbcode.left} </span>
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[align=left]', '[/align]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch">
											<span class=""><i class="fa fa-fw fa-align-center"></i> {@bbcode.center} </span>
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[align=center]', '[/align]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch">
											<span class=""><i class="fa fa-fw fa-align-right"></i> {@bbcode.right} </span>
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[align=right]', '[/align]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch">
											<span class=""><i class="fa fa-fw fa-align-justify"></i> {@bbcode.justify} </span>
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[align=justify]', '[/align]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
									</ul>
								</nav>
							</div>
								...
								<div class="cell-list">
									<ul>
										<li class="li-stretch{AUTH_FLOAT}">
											...
											<span class="button hide-modal close-bbcode-sub"# IF NOT C_DISABLED_FLOAT# onclick="insertbbcode('[float=left]', '[/float]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch{AUTH_FLOAT}">
											<span class=""><i class="fa fa-fw fa-step-forward"></i>  {@bbcode.float.right} </span>
											<span class="button hide-modal close-bbcode-sub"# IF NOT C_DISABLED_FLOAT# onclick="insertbbcode('[float=right]', '[/float]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch{AUTH_INDENT}">
											<span class=""><i class="fa fa-fw fa-indent"></i> {@bbcode.indent} </span>
											<span class="button hide-modal close-bbcode-sub"# IF NOT C_DISABLED_INDENT# onclick="insertbbcode('[indent]', '[/indent]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch{AUTH_SUP}">
											<span class=""><i class="fa fa-fw fa-superscript"></i> {@bbcode.sup}</span>
											<span class="button hide-modal close-bbcode-sub"# IF NOT C_DISABLED_SUP# onclick="insertbbcode('[sup]', '[/sup]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch{AUTH_SUB}">
											<span class=""><i class="fa fa-fw fa-subscript"></i>  {@bbcode.sub} </span>
											<span class="button hide-modal close-bbcode-sub"# IF NOT C_DISABLED_SUB# onclick="insertbbcode('[sub]', '[/sub]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</span>
										</li>
									</ul>
								</div>
							</div>
							...
							<div class="content-panel cell">
								...
								<div class="cell-body">
									<div class="cell-content flex-between">
										...
										<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[title=1]', '[/title]', '{FIELD}');">{@bbcode.tags.add}</span>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content flex-between">
										<h3 class="formatter-title">{@bbcode.title.label} 2</h3>
										<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[title=2]', '[/title]', '{FIELD}');">{@bbcode.tags.add}</span>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content flex-between">
										<h4 class="formatter-title">{@bbcode.title.label} 3</h4>
										<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[title=3]', '[/title]', '{FIELD}');">{@bbcode.tags.add}</span>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content flex-between">
										<h5 class="formatter-title">{@bbcode.title.label} 4</h5>
										<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[title=4]', '[/title]', '{FIELD}');">{@bbcode.tags.add}</span>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content flex-between">
										<h6 class="formatter-title">{@bbcode.title.label} 5</h6>
										<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[title=5]', '[/title]', '{FIELD}');">{@bbcode.tags.add}</span>
									</div>
								</div>
							</div>
						</div>
					...
					<li id="html-list" class="bbcode-elements">
						...
						<div id="block-list{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_list('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="html-table" class="bbcode-elements">
						...
						<div id="block-table{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_table('{FIELD}');">{@bbcode.insert.table}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="html-containers" class="bbcode-elements">
								...
								<nav class="cell-list">
									<ul>
										<li id="html-paragraph" class="li-stretch{AUTH_P}">
											...
											<span class="button hide-modal close-bbcode-sub" # IF NOT C_DISABLED_P#onclick="insertbbcode('[p]', '[/p]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</span>
										</li>
										<li id="html-div-block" class="li-stretch{AUTH_BLOCK}">
											<span class="bbcode-label"> {@bbcode.block} </span>
											<span class="button hide-modal close-bbcode-sub" # IF NOT C_DISABLED_BLOCK #onclick="insertbbcode('[block]', '[/block]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</span>
										</li>
						...
						<div id="block-custom-div{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_custom_div('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
						<div id="block-fieldset{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_fieldset('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
						<div id="block-abbr{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_abbr('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="html-quote" class="bbcode-elements">
						...
						<div id="block-quote{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_quote('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
								...
								<div class="cell-list">
									<ul>
										<li class="li-stretch{AUTH_HIDE}">
											...
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[hide]', '[/hide]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch{AUTH_MEMBER}">
											<span class=""><i class="fa fa-fw fa-user-friends" role="contentinfo"></i> {@bbcode.hide.member}</span>
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[member]', '[/member]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch{AUTH_TEASER}">
											<span class=""><i class="fa fa-fw fa-user" role="contentinfo"></i> {@bbcode.hide.teaser}</span>
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[teaser]', '[/teaser]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
										<li class="li-stretch{AUTH_MODERATOR}">
											...
											<span class="button hide-modal close-bbcode-sub" onclick="insertbbcode('[moderator]', '[/moderator]', '{FIELD}');">{@bbcode.tags.add}</span>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="cell-body">
									<div class="cell-content">
										<div class="message-helper bgc notice flex-between">
											...
											<span class="button bgc-full notice hide-modal close-bbcode-sub" onclick="insertbbcode('[style=notice]', '[/style]', '{FIELD}');">{@bbcode.tags.add}</span>
										</div>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content">
										<div class="message-helper bgc question flex-between">
											...
											<span class="button bgc-full question hide-modal close-bbcode-sub" onclick="insertbbcode('[style=question]', '[/style]', '{FIELD}');">{@bbcode.tags.add}</span>
										</div>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content">
										<div class="message-helper bgc success flex-between">
											...
											<span class="button bgc-full success hide-modal close-bbcode-sub" onclick="insertbbcode('[style=success]', '[/style]', '{FIELD}');">{@bbcode.tags.add}</span>
										</div>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content">
										<div class="message-helper bgc warning flex-between">
											...
											<span class="button bgc-full warning hide-modal close-bbcode-sub" onclick="insertbbcode('[style=warning]', '[/style]', '{FIELD}');">{@bbcode.tags.add}</span>
										</div>
									</div>
								</div>
								<div class="cell-body">
									<div class="cell-content">
										<div class="message-helper bgc error flex-between">
											...
											<span class="button bgc-full error hide-modal close-bbcode-sub" onclick="insertbbcode('[style=error]', '[/style]', '{FIELD}');">{@bbcode.tags.add}</span>
										</div>
									</div>
								</div>
							</div>
					...
					<li id="html-hr" class="bbcode-elements">
						<span class="bbcode-button{AUTH_LINE} close-bbcode-sub" # IF NOT C_DISABLED_S #onclick="insertbbcode('[line]', '', '{FIELD}');"# ENDIF # role="button" aria-label="{@bbcode.line}">
			...
			<li class="bbcode-group bbcode-links">
				<span class="bbcode-group-title bbcode-button" aria-label="{@bbcode.links}"><i class="fa fa-fw fa-link" aria-hidden="true"></i></span>
				<ul class="bbcode-container modal-container cell-modal cell-tile">
					<li id="links-url" class="bbcode-elements">
						...
						<div id="block-url{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_link('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="links-mail" class="bbcode-elements">
						...
						<div id="block-mail{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_mail('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="links-wikipedia" class="bbcode-elements">
						...
						<div id="block-wikipedia{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_wikipedia('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="links-feed" class="bbcode-elements">
						...
						<div id="block-feed{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_feed('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="links-anchor" class="bbcode-elements">
						...
						<div id="block-anchor{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_anchor('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
			...
			<li class="bbcode-group bbcode-files">
				<span class="bbcode-group-title bbcode-button" aria-label="{@bbcode.files}"><i class="fa fa-fw fa-file-import" aria-hidden="true"></i></span>
				<ul class="bbcode-container modal-container cell-modal cell-tile">
					<li id="links-sound" class="bbcode-elements">
						...
						<div id="block-sound{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_sound('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="links-movie" class="bbcode-elements">
						...
						<div id="block-movie{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_movie('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="link-lightbox" class="bbcode-elements">
						...
						<div id="block-lightbox{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_lightbox('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="link-figure" class="bbcode-elements">
						...
						<div id="block-figure{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_figure('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
			...
			<li class="bbcode-group bbcode-icons">
				<span class="bbcode-group-title bbcode-button" aria-label="{@bbcode.icons}">
				...
				<ul class="bbcode-container modal-container cell-modal cell-tile">
							...
							<div class="content-panel cell">
								...
								<div class="cell-list cell-list-inline">
									<ul>
										# START smileys #
											<li>
												<span class="hide-modal close-bbcode-sub" onclick="insertbbcode('{smileys.CODE}', 'smile', '{FIELD}');" role="button" aria-label="{smileys.CODE}">
					...
					<li id="emojis" class="bbcode-elements">
						<span class="bbcode-button {AUTH_EMOJI}" # IF NOT C_DISABLED_EMOJI #data-modal# ENDIF # data-target="block-emojis{FIELD}" role="button" aria-label="{@bbcode.emojis}">
							<span class="stacked">
								<i class="far fa-fw fa-smile" aria-hidden="true"></i>
											...
											# ELSE #
												...
												# ELSE #
													<li# IF emojis.C_END_LINE # class="hidden"# ENDIF #>
														<span class="hide-modal close-bbcode-sub bigger emoji-tag" onclick="insertbbcode('[emoji]{emojis.DECIMAL}[/emoji]', '', '{FIELD}');" role="button"# IF emojis.C_NAME # aria-label="{emojis.NAME}"# ENDIF #>
															{emojis.DECIMAL}
														</span>
													</li>
												# ENDIF #
							...
							<div class="content-panel cell">
								...
								<div class="cell-list cell-list-inline">
									<ul>
										# START code_fa #
											<li>
												<span class="hide-modal close-bbcode-sub" onclick="insertbbcode('[fa# IF code_fa.C_CUSTOM_PREFIX #={code_fa.PREFIX}# ENDIF #]{code_fa.CODE}[/fa]', '', '{FIELD}');" role="button" aria-label="{code_fa.CODE}">
			...
			<li class="bbcode-group bbcode-code">
				<span class="bbcode-group-title bbcode-button" aria-label="{@bbcode.format.code}"><i class="fa fa-fw fa-file-code" aria-hidden="true"></i></span>
				<ul class="bbcode-container modal-container cell-modal cell-tile">
					<li id="code-language" class="bbcode-elements">
						...
						<div id="block-code{FIELD}" class="modal modal-animation">
							...
							<div class="content-panel cell">
								...
								<div class="cell-footer cell-input">
									<span class="button hide-modal close-bbcode-sub" onclick="bbcode_code('{FIELD}');">{@bbcode.tags.add}</span>
								</div>
							</div>
						</div>
					</li>
					<li id="code-math" class="bbcode-elements">
						<span class="bbcode-button{AUTH_MATH} close-bbcode-sub" # IF NOT C_DISABLED_MATH #onclick="insertbbcode('[math]', '[/math]', '{FIELD}');"# ENDIF # role="button" aria-label="{@bbcode.math}">
							<i class="fa fa-fw fa-calculator" aria-hidden="true"></i>
						</span>
					</li>
					<li id="code-html" class="bbcode-elements">
						<span class="bbcode-button{AUTH_HTML} close-bbcode-sub" # IF NOT C_DISABLED_HTML #onclick="insertbbcode('[html]', '[/html]', '{FIELD}');"# ENDIF # role="button" aria-label="{@bbcode.html}">
			...
			<li class="bbcode-group">
				<span id="resize-textarea" class="collapse bbcode-group-title bbcode-button" aria-label="{@bbcode.collapse}"><i class="fa fa-fw fa-compress" aria-hidden="true"></i></span>
			</li>
		</ul>
	</nav>
</div>
