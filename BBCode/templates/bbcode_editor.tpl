...
<!--
	var BBcodeEditor = Class.create(BBcodeEditor_Core,
	{
		...
		block2: [
			...
			{type:'separator'},
			{type:'balise2', fname:'flash.png', label:${escapejs(L_BB_FLASH)}, begintag: 'swf=425,344', endtag:'swf', disabled:${escapejs(DISABLED_SWF)}},
			{type:'balise2', fname:'movie.png', label:${escapejs(L_BB_MOVIE)}, begintag: 'movie=100,100', endtag:'movie', disabled:${escapejs(DISABLED_MOVIE)}},
