		...
		<div class="bbcode-containers">
			<ul class="bbcode-container">
				<li class="bbcode-elements">
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block1{FIELD}">
				...
				<li class="bbcode-elements">
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block2{FIELD}">
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block3{FIELD}">
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block4{FIELD}">
				...
				<li class="bbcode-elements">
					...
					<i class="bbcode-icon-lightbox"></i> 
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block9{FIELD}">
						<div class="bbcode-block" style="margin-left:260px;" onmouseover="bb_hide_block('9', '{FIELD}', 1);" onmouseout="bb_hide_block('9', '{FIELD}', 0);">
							...
							<p style="text-align:center;"><a class="small" href="javascript:bbcode_list('{FIELD}');">
								<i class="bbcode-icon-list" title="{L_BB_LIST}" class="valign-middle"></i> {L_INSERT_LIST}
							</a></p>
						</div>
					</div>
				</li>
				<li class="bbcode-elements">
					...
					<div class="color-picker" style="position:absolute;z-index:100;display:none;" id="bb_block5{FIELD}">
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block6{FIELD}">
				...
				<li class="bbcode-elements">
					<i class="bbcode-icon-minus" onclick="textarea_resize('{FIELD}', -100, 'height');textarea_resize('xmlhttprequest-preview', -100, 'height');" title="{L_BB_SMALL}"></i>
					<i class="bbcode-icon-plus" onclick="textarea_resize('{FIELD}', 100, 'height');textarea_resize('xmlhttprequest-preview', 100, 'height');" title="{L_BB_LARGE}"></i>
					<a onclick="show_bbcode_div('bbcode_more{FIELD}', 1);" style="display:inline-block; float:right;"><i class="bbcode-icon-more" title="{L_BB_MORE}" class="bbcode-hover"></i></a>
				</li>
			</ul>
			...
			<ul class="bbcode-container bbcode-more" id="bbcode_more{FIELD}">
				...
				<li class="bbcode-elements">
					<i class="bbcode-icon-float-left" {AUTH_FLOAT} onclick="{DISABLED_FLOAT}insertbbcode('[float=left]', '[/float]', '{FIELD}');" title="{L_BB_FLOAT_LEFT}"></i>
					<i class="bbcode-icon-float-right" {AUTH_FLOAT} onclick="{DISABLED_FLOAT}insertbbcode('[float=right]', '[/float]', '{FIELD}');" title="{L_BB_FLOAT_RIGHT}"></i>
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block7{FIELD}">
						<div id="bbtable{FIELD}" class="bbcode-block" style="margin-left:130px;width:180px;" onmouseover="bb_hide_block('7', '{FIELD}', 1);" onmouseout="bb_hide_block('7', '{FIELD}', 0);">
							<p><label style="font-size:10px;font-weight:normal">* {L_LINES} <input size="3" type="text" name="bb_lines{FIELD}" id="bb_lines{FIELD}" maxlength="3" value="2"></label></p>
							<p><label style="font-size:10px;font-weight:normal">* {L_COLS} <input size="3" type="text" name="bb_cols{FIELD}" id="bb_cols{FIELD}" maxlength="3" value="2"></label></p>
				...
				<li class="bbcode-elements">
					...
					<div style="position:absolute;z-index:100;display:none;" id="bb_block8{FIELD}">
