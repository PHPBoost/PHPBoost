								...
								<nav class="cell-list">
									<ul>
										<li id="html-paragraph" class="li-stretch{AUTH_P}">
											...
											<a href="#paragraph-insert" class="button close-modal close-bbcode-sub" # IF NOT C_DISABLED_P#onclick="insertbbcode('[p]', '[/p]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</a>
										</li>
										<li id="html-div-block" class="li-stretch{AUTH_BLOCK}">
											<span class="bbcode-label"> {@bbcode.block} </span>
											<a href="#block-insert" class="button close-modal close-bbcode-sub" # IF NOT C_DISABLED_BLOCK #onclick="insertbbcode('[block]', '[/block]', '{FIELD}');"# ENDIF #>{@bbcode.tags.add}</a>
										</li>
										<li id="html-div-custom" class="li-stretch{AUTH_CONTAINER}">
											<span class="bbcode-label"> {@bbcode.custom.div} </span>
											<span href="#custom-select" class="button# IF NOT C_DISABLED_CONTAINER # modal-button --block-custom-div{FIELD}# ENDIF #" role="button" aria-label="{@bbcode.tags.options}"> {@bbcode.tags.choice} </span>
										</li>
						...
						<div id="block-fieldset{FIELD}" class="modal modal-half">
							...
							<div class="modal-content cell cell-bbcode">
								<div class="cell-header">
									...
									<a href="#cancel" class="error close-modal close-bbcode-sub" aria-label="{@bbcode.tags.cancel}"><i class="far fa-circle-xmark" aria-hidden="true"></i></a>
								</div>
								<div class="cell-form">
				...
				<ul class="bbcode-container cell-tile">
					...
					<li id="files-lightbox" class="bbcode-elements">
						...
						<div id="block-lightbox{FIELD}" class="modal modal-half">
							<div class="modal-overlay close-modal" role="button" aria-label="{@common.close}"></div>
							<div class="modal-content cell cell-bbcode">
                                <span href="#cancel" class="error hide-modal close-modal close-bbcode-sub" aria-label="{@bbcode.tags.cancel}"><i class="far fa-circle-xmark" aria-hidden="true"></i></span>
								<div class="cell-header">
