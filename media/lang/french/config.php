...
<ul class="formatter-ul">
	<li class="formatter-li"> Pour configurer ou personnaliser l\'accueil de votre module, rendez vous dans l\'<a href="' . MediaUrlBuilder::configuration()->rel() . '">administration du module</a></li>
	<li class="formatter-li"> Pour créer des catégories, <a href="' . MediaUrlBuilder::add_category()->rel() . '">cliquez ici</a> </li>
	<li class="formatter-li"> Pour créer des fichiers multimédias, <a href="' . MediaUrlBuilder::add()->rel() . '">cliquez ici</a></li>
</ul>
