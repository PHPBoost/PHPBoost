			...
			<article id="article-media-{file.ID}" class="article-media article-several# IF file.C_NEW_CONTENT # new-content# ENDIF #">
				...
				# IF C_MODO #
					<span class="actions">
						...
						<a href="{file.U_ADMIN_DELETE_MEDIA}" data-confirmation="delete-element" aria-label="${LangLoader::get_message('delete', 'common')}"><i class="fa fa-delete"></i></a>
					</span>
				# ENDIF #
		...
		<div id="article-media-{ID}" class="article-media# IF C_NEW_CONTENT # new-content# ENDIF #">
			<div class="actions">
				...
				# IF C_MODO #
					...
					<a href="{U_DELETE_MEDIA}" data-confirmation="delete-element" aria-label="${LangLoader::get_message('delete', 'common')}"><i class="fa fa-delete"></i></a>
				# ENDIF #
			</div>
			<div class="content">
