...
class AdminHomePageAddPluginController extends AdminController
{
	...
	private function build_plugin_choice($column_selected, $plugin_selected)
	{
		...
		array('events' => array('change' => 'document.location = "'. HomePageUrlBuilder::add_plugin($column_selected, $plugin_selected)->rel() .'" + HTMLForms.getField("PluginSelect").getValue();'))));
		return $form;
	}
