...
class NewsDisplayNewsTagController extends ModuleController
{
	...
	public function build_view()
	{
		...
		WHERE relation.id_keyword = :id_keyword AND (news.approbation_type = 1 OR (news.approbation_type = 2 AND news.start_date < :timestamp_now AND end_date > :timestamp_now))', array(
