...
class UTPath extends PHPBoostUnitTestCase
{
	public function test_phpboost_path()
	{
		$this->assertEquals(realpath(PATH_TO_ROOT), Path::phpboost_path());
	}
	...
	public function test_get_path_from_root()
	{
		...
		$this->assertEquals($path_from_root, Path::get_path_from_root($path));
	}
	...
	public function test_get_package()
	{
		...
		$this->assertEquals($package, Path::get_package($class_file));
	}
	...
	public function test_get_classname()
	{
		...
		$this->assertEquals($classname, Path::get_classname($class_file));
	}
