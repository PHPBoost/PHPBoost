...
//Execute update
	...
	'finish.message' => '<fieldset>
							...
							<div class="fielset-inset">
								...
								<p class="message-helper warning">Merci de récupérer le <a href="{PATH_TO_ROOT}/update/update_log.txt">fichier de log</a> de votre migration, il pourra vous être demandé sur le forum PHPBoost en cas de demande de support sur votre migration.</p>
