...
//Execute update
	...
	'finish.message' => '<fieldset>
							...
							<div class="fielset-inset">
								...
								<p class="message-helper warning">Please download the <a href="{PATH_TO_ROOT}/update/update_log.txt">log file</a> of your update, it could be required on PHPBoost forum if you ask for support.</p>
