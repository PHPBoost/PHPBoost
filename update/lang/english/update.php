...
//Finish update
	'finish.message' => '<fieldset>
							...
							<div class="fielset-inset">
								...
								<p class="message-helper warning">Please download the <a href="' . GeneralConfig::load()->get_complete_site_url() . '/update/update_log.txt">log file</a> of your update, it could be required on PHPBoost forum if you ask for support.</p>
