...
class ArticlesConfigUpdateVersion extends ConfigUpdateVersion
{
	...
	protected function build_new_config()
	{
		...
		$articles_config->set_nbr_articles_max($config['nbr_articles_max']);
		$articles_config->set_nbr_cat_max($config['nbr_cat_max']);
		$articles_config->set_nbr_columns($config['nbr_column']);
		$articles_config->set_note_max($config['note_max']);
		$articles_config->set_authorizations($this->build_authorizations($config['global_auth']));
		ArticlesConfig::save();
