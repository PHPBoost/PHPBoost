...
class PagesModuleUpdateVersion extends ModuleUpdateVersion
{
	...
	{
		$file = new File(Url::to_rel('/' . $this->module_id . '/templates/error.tpl'));
		$file->delete();
		$file = new File(Url::to_rel('/' . $this->module_id . '/templates/index.php'));
		$file->delete();
		$file = new File(Url::to_rel('/' . $this->module_id . '/templates/redirections.tpl'));
		$file->delete();
		$file = new File(Url::to_rel('/' . $this->module_id . '/redirections.php'));
		$file->delete();
