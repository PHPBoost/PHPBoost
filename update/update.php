	...
	case STEP_DB_MAJ :
		if (retrieve(POST, 'submit', false))
        {
			...
			{	
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (9, 'download', 'a:5:{s:12:\"nbr_file_max\";i:10;s:10:\"nbr_column\";i:2;s:8:\"note_max\";i:5;s:13:\"root_contents\";s:50:\"Bienvenue dans l''espace de téléchargement du site!\";s:11:\"global_auth\";a:3:{s:3:\"r-1\";i:1;s:2:\"r0\";i:5;s:2:\"r1\";i:7;}}')");
			}
			...
			{	
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (19, 'poll', 'a:4:{s:9:\"poll_auth\";i:-1;s:9:\"poll_mini\";a:1:{i:0;s:1:\"1\";}s:11:\"poll_cookie\";s:4:\"poll\";s:18:\"poll_cookie_lenght\";i:2592000;}')");
			}
			if (isset($MODULES['articles']))
			{
				$Sql->parse('migration_articles_2.0_to_3.0.sql');
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (6, 'articles', 'a:5:{s:16:\"nbr_articles_max\";i:10;s:11:\"nbr_cat_max\";i:10;s:10:\"nbr_column\";i:2;s:8:\"note_max\";i:5;s:9:\"auth_root\";s:59:\"a:4:{s:3:\"r-1\";i:1;s:2:\"r0\";i:1;s:2:\"r1\";i:1;s:2:\"r2\";i:1;}\";}')");
			}
			...
			if (isset($MODULES['faq']))
			{
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (10, 'faq', 'a:5:{s:8:\"faq_name\";s:12:\"FAQ PHPBoost\";s:8:\"num_cols\";i:4;s:13:\"display_block\";b:0;s:11:\"global_auth\";a:4:{s:3:\"r-1\";i:1;s:2:\"r0\";i:1;s:2:\"r1\";i:3;s:2:\"r2\";i:3;}s:4:\"root\";a:3:{s:12:\"display_mode\";i:0;s:4:\"auth\";a:4:{s:3:\"r-1\";i:1;s:2:\"r0\";i:1;s:2:\"r1\";i:3;s:2:\"r2\";i:3;}s:11:\"description\";s:23:\"Bienvenue dans la FAQ !\";}}')");
				
			}
			if (isset($MODULES['calendar']))
			{
				$Sql->query_inject("ALTER TABLE `phpboost_calendar` CHANGE `contents` `contents` text", __LINE__, __FILE__);
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (7, 'calendar', 'a:1:{s:13:\"calendar_auth\";i:2;}')");
			}
			if (isset($MODULES['contact']))
			{
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (8, 'contact', 'a:2:{s:17:\"contact_verifcode\";i:1;s:28:\"contact_difficulty_verifcode\";i:2;}')");
			}
			if (isset($MODULES['online']))
			{
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (17, 'online', 'a:2:{s:16:\"online_displayed\";i:4;s:20:\"display_order_online\";s:33:\"s.level DESC, s.session_time DESC\";}')");
			}
			if (isset($MODULES['guestbook']))
			{
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (13, 'guestbook', 'a:5:{s:14:\"guestbook_auth\";i:-1;s:24:\"guestbook_forbidden_tags\";s:52:\"a:3:{i:0;s:3:\"swf\";i:1;s:5:\"movie\";i:2;s:5:\"sound\";}\";s:18:\"guestbook_max_link\";i:2;s:19:\"guestbook_verifcode\";i:0;s:30:\"guestbook_difficulty_verifcode\";i:0;}')");
			}
			if (isset($MODULES['newsletter']))
			{
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (16, 'newsletter', 'a:2:{s:11:\"sender_mail\";s:0:\"\";s:15:\"newsletter_name\";s:0:\"\";}')");
			}
			...
			{	
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (23, 'wiki', 'a:6:{s:4:\"auth\";s:71:\"a:4:{s:3:\"r-1\";i:1041;s:2:\"r0\";i:1299;s:2:\"r1\";i:4095;s:2:\"r2\";i:4095;}\";s:9:\"wiki_name\";s:13:\"Wiki PHPBoost\";s:13:\"last_articles\";i:0;s:12:\"display_cats\";i:0;s:10:\"index_text\";s:22:\"Bienvenue sur le wiki.\";s:10:\"count_hits\";i:1;}')");
			}
			if (isset($MODULES['web']))
			{
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (22, 'web', 'a:4:{s:11:\"nbr_web_max\";i:10;s:11:\"nbr_cat_max\";i:10;s:10:\"nbr_column\";i:2;s:8:\"note_max\";i:5;}')");
			}
			if (isset($MODULES['pages']))
			{
				...
				$Sql->query_inject("INSERT INTO `phpboost_configs` (`id`, `name`, `value`) VALUES (18, 'pages', 'a:3:{s:10:\"count_hits\";i:1;s:9:\"activ_com\";i:1;s:4:\"auth\";s:59:\"a:4:{s:3:\"r-1\";i:5;s:2:\"r0\";i:7;s:2:\"r1\";i:7;s:2:\"r2\";i:7;}\";}')");
			}
