...
class CalendarUrlBuilder
{
	 ...
	 * @return Url
	 */
	public static function display_item($category_id, $rewrited_name_category, $item_id, $rewrited_title)
	{
	 ...
	 * @return Url
	 */
	public static function display_item_comments($category_id, $rewrited_name_category, $item_id, $rewrited_title)
	{
