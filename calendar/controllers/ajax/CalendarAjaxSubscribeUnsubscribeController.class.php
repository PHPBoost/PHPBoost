...
class CalendarAjaxSubscribeUnsubscribeController extends AbstractController
{
	...
	{
		if (!$this->event->is_registration_authorized() || !$this->event->is_authorized_to_register() || ($this->event->is_registration_authorized() && $this->event->get_registred_members_number() == $this->event->get_max_registred_members()) || time() > $this->event->get_start_date()->get_timestamp())
		{
