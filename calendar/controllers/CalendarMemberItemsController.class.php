...
class CalendarMemberItemsController extends ModuleController
{
	...
	private function generate_response()
	{
		...
		$graphical_environment->set_page_title($this->user_lang['my.items'], $this->lang['calendar.module.title'], $page);
		...
		$breadcrumb->add($this->user_lang['my.items'], CalendarUrlBuilder::display_member_items($page));
