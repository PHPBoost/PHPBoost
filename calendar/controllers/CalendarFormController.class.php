...
{     
	...
	{
		return (!CalendarAuthorizationsService::check_authorizations($this->get_event()->get_category_id())->write() && CalendarAuthorizationsService::check_authorizations($this->get_event()->get_category_id())->contribution());
	}
