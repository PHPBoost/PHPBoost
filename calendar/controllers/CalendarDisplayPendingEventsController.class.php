...
class CalendarDisplayPendingEventsController extends ModuleController
{
	...
	public function build_view(HTTPRequestCustom $request)
	{
		...
		WHERE approved = 0 AND parent_id = 0 AND id_category IN :authorized_categories" . (!CalendarAuthorizationsService::check_authorizations()->moderation() ? ' AND event_content.author_id = ' . AppContext::get_current_user()->get_id() : '') . "'
