...
<div id="admin_quick_menu">
	<ul>
		...
		<li><a href="admin_calendar.php"><img src="calendar.png" alt="" /> </a>
			<br /> <a href="admin_calendar.php" class="quick_link">{L_CALENDAR_CONFIG}</a>
		</li>
	</ul>
</div>
...
<div id="admin_contents">
	...
	<form action="admin_calendar.php?token={TOKEN}" method="post"
