...
<table>
	...
	<tbody>
		...
		<tr> 
			...
			<td> 
				<a href="{events.U_EDIT}" title="${LangLoader::get_message('edit', 'main')}" class="edit"></a>
				<a href="{events.U_DELETE}" title="${LangLoader::get_message('delete', 'main')}" class="delete"></a>
			</td>
		</tr>
		# END events #
		# IF NOT C_EVENTS #
