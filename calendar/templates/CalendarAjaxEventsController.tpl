<section id="module-calendar-events">
				...
				# IF C_EVENTS #
					<div class="cell-row">
						# START event #
							<article itemscope="itemscope" itemtype="http://schema.org/Event" id="article-calendar-{event.ID}" class="calendar-item several-items cell# IF event.C_NEW_CONTENT # new-content# ENDIF #">
