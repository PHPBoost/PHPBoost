...
if( $id_cat != 0 )
{
	...
	while( $row = $Sql->fetch_assoc($result) )
	{
		...
		if( $sub_cats_number > 0 )
			...
			echo '<li style="padding-left:17px;"><img src="../templates/' . uget_theme() . '/images/upload/closed_cat.png" alt=""  style="vertical-align:middle" />&nbsp;<span id="class_' . $row['id'] . '" class=""><a href="javascript:' . ($display_select_link != 0 ? 'select_cat' : 'open_cat') . '(' . $row['id'] . ');">' . $row['name'] . '</a></span></li>';
	}
