...
class MemberHomeProfileController extends AbstractController
{
	...
	private function build_form($user_id)
	{
		...
		$this->tpl->put_all(array(
			...
			'MSG_MBR' => $msg_mbr,
			'U_USER_ID' => MemberUrlBuilder::profile($user_id)->absolute(),
			'U_USER_PM' => MemberUrlBuilder::personnal_message($user_id)->absolute(),
			'U_CONTRIBUTION_PANEL' => MemberUrlBuilder::contribution()->absolute(),
			'U_MODERATION_PANEL' => MemberUrlBuilder::moderation()->absolute(),
			'U_UPLOAD' => MemberUrlBuilder::upload()->absolute(),
			'U_EDIT_PROFILE' => MemberUrlBuilder::edit_profile()->absolute(),
