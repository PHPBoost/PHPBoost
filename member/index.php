...
$url_controller_mappers = array(
	   new UrlControllerMapper('MemberLostPasswordController', '`^/forget(?:/([a-z0-9]+))?/?$`', array('key')),
       ...
       new UrlControllerMapper('MemberViewAllMembersController', '`^(?:/([a-z]+))?/?([a-z]+)?/?([0-9]+)?/?$`', array('field', 'sort', 'page')),
);
