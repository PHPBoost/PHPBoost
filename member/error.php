...
if( in_array($id_error, $array_error) )
{
	if( $User->get_attribute('user_id') === -1 )
	{
		...
		$Template->assign_vars(array(
			...
			'U_REGISTER' => $CONFIG_MEMBER['activ_register'] ? '<a href="../member/register.php"><img src="../templates/' . get_utheme() . '/images/register_mini.png" alt="" class="valign_middle" /> ' . $LANG['register'] . '</a><br />' : ''
		));
