...
if (in_array($id_error, $array_error))
{
	if ($User->get_attribute('user_id') === -1)
	{
		...
		$Template->put_all(array(
			...
			'U_REGISTER' => UserAccountsConfig::load()->is_registration_enabled() ? '<a href="'. MemberUrlBuilder::registeration()->absolute() .'"><img src="../templates/' . get_utheme() . '/images/register_mini.png" alt="" class="valign_middle" /> ' . $LANG['register'] . '</a><br />' : ''
		));
