	...
	<div id="footer">
		...
		<div id="footer_social">
			<a href="http://www.facebook.com/pages/PHPBoost-CMS/229132847163144">
				<img src="{PATH_TO_ROOT}/templates/{THEME}/theme/images/facebook_logo.png" class="footer_social_img" />
			</a>
		</div>	
		<div id="footer_links">
