		...
		<div id="admin_contents">
			<fieldset class="fieldset_content">
				...
				<table class="module_table">
					...
					<tr style="text-align:center;"> 
						<td class="row2">
							<a href="../member/member{group.LINK}">{group.NAME}</a>
						</td>
						<td class="row2">
							{group.IMAGE}
						</td>
						<td class="row2"> 
							<a href="admin_groups.php?id={group.ID}"><img src="../templates/{THEME}/images/{LANG}/edit.png" alt="{L_UPDATE}" title="{L_UPDATE}" /></a>
						</td>
						<td class="row2">
							<a href="admin_groups.php?del=1&amp;id={group.ID}" onClick="javascript:return Confirm();"><img src="../templates/{THEME}/images/{LANG}/delete.png" alt="{L_DELETE}" title="{L_DELETE}" /></a>
						</td>
					</tr>
					# END group #
