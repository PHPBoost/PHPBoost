		...
		<div id="admin_contents">
			...
			<form action="admin_members.php" enctype="multipart/form-data" method="post" onsubmit="return check_form();" class="fieldset_content">
				<fieldset>
					...
					<dl>
						<dt><label for="user_lang">{L_LANGUAGE}</label></dt>
						<dd><label>
					...
					<dl>
						<dt><label for="user_theme">{L_THEME}</label></dt>
						<dd><label>
				...
				<fieldset>
					...
					<dl>
						...
						<dd><label><input type="text" maxlength="40" size="40" name="avatar" id="avatar" value="{AVATAR_LINK}" class="text" /></label></dd>
					</dl>	
					<dl>
