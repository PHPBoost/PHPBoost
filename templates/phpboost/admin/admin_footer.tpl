		...
		<div id="footer">
			<span>
				...
				{L_POWERED_BY} <a href="http://www.phpboost.com" title="PHPBoost">PHPBoost {VERSION}</a> &copy; <a href="http://www.phpboost.com" title="PHPBoost">PHPBoost</a> {L_PHPBOOST_RIGHT}
			</span>	
			<br />
			<span>
				{L_ACHIEVED} {BENCH}s - {REQ} {L_REQ}
			</span>	
			<br />
			<span>
