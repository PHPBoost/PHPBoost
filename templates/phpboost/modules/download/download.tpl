# IF C_ROOT_AND_EXPLORE #
	<section>
		<header>
			<h1>
				<a href="${relative_url(SyndicationUrlBuilder::rss('download',IDCAT))}" class="fa fa-syndication" title="${LangLoader::get_message('syndication', 'common')}"></a>
				{TITLE}
				# IF C_ADMIN #
				<span class="actions">
				...
				<div class="pbt-button-container">
					<div class="pbt-button pbt-button-blue">
						<a href="{PATH_TO_ROOT}/download/file-299+phpboost-4-1.php" class="pbt-button-a">
							...
							<p class="pbt-button-com">Rev : 4.1.4 | Req : PHP 5.3 | .zip </p>
						</a>
					</div>
				...
				<div class="pbt-button-container">
					<div class="pbt-button pbt-button-blue">
						<a href="{PATH_TO_ROOT}/download/file-229+phpboost-4-0.php" class="pbt-button-a">
							...
							<p class="pbt-button-com">Rev : 4.0.6 | Req : PHP 5.1.2 | .zip </p>
						</a>
					</div>
					<div class="pbt-button pbt-button-green">
