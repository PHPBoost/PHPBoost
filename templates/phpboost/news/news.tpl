		...
		<div class="news_container" style="float:left;width:93%;margin-left:25px;">
			<div class="news_top_l"></div>			
			<div class="news_top_r"></div>
			<div class="news_top">
...
<ul class="bb_ul"><li class="bb_li">Projet Open Source sous licence GNU/GPL
		...
		<div class="news_container" style="float:left;width:93%;margin-left:25px;">
			...
			<div class="news_top_r"></div>
			<div class="news_top">
				<h3 class="title valign_middle"><a href="../forum/rss.php" title="Rss"><img class="valign_middle" src="../templates/{THEME}/images/rss.png" alt="Rss" title="Rss" /></a> Site de la semaine</h3>
			</div>						
			<div class="news_content">
