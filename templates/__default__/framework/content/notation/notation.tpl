# IF C_STATIC_DISPLAY #
	# IF C_NOTES #
		<div role="note" aria-label="${LangLoader::get_message('common.note', 'common-lang')}: {AVERAGE_NOTES}/{NOTATION_SCALE}" class="notation static-notation" itemprop="aggregateRating" itemscope="itemscope" itemtype="https://schema.org/AggregateRating">
			# START star #
...
# ELSE #
	...
	<div class="notation" id="notation-{ID_IN_MODULE}" # IF C_NOTES #itemprop="aggregateRating" itemscope="itemscope" itemtype="https://schema.org/AggregateRating"# ENDIF #>
		<span class="stars">
			# START star #
				<a aria-label="${LangLoader::get_message('common.add.note', 'common-lang')} {star.I}/{NOTATION_SCALE}" href="#" onclick="return false;" class="far star fa-star" id="star-{ID_IN_MODULE}-{star.I}"><span class="star-width {star.STAR_WIDTH}"></span></a>
			# END star #
		</span>
		<span class="notes">
