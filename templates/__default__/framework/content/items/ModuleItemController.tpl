<section id="module-{MODULE_ID}" class="category-{CATEGORY_ID}">
	...
	# ELSE #
		<article id="{MODULE_ID}-item-{ID}" class="sub-section {MODULE_ID}-item single-item# IF C_PRIME_ITEM # prime-item# ENDIF ## IF C_NEW_CONTENT # new-content# ENDIF #" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
