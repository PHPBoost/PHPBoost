<section id="module-{MODULE_ID}">
	...
	# IF C_CATEGORY_DESCRIPTION #
		<div class="cat-description sub-section">
			{CATEGORY_DESCRIPTION}
		</div>
	# ENDIF #

	# IF C_SUB_CATEGORIES #
		<div class="cell-flex cell-tile cell-columns-{CATEGORIES_PER_ROW} sub-section">
	...
	# IF C_ITEMS #
		...
		# ENDIF #
		# IF C_TABLE_VIEW #
			<div class="responsive-table sub-section">
				<table class="table">
					<thead>
						<tr>
		...
		# ELSE #
			<div class="sub-section # IF C_GRID_VIEW #cell-flex cell-columns-{ITEMS_PER_ROW}# ELSE #cell-row# ENDIF #">
				# START items #
