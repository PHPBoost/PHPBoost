...
<div id="${escape(HTML_ID)}" class="modal# IF CSS_CLASS # {CSS_CLASS}# ENDIF #"# IF C_DISABLED # style="display: none;"# ENDIF #>
	...
	<div class="modal-content fieldset-inset">
		<span href="#" class="error big hide-modal close-modal" aria-label="${LangLoader::get_message('common.close', 'common-lang')}"><i class="far fa-circle-xmark" aria-hidden="true"></i></span>
