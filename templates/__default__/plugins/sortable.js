 ...
 * @copyright   &copy; 2005-2022 PHPBoost - 2012 Jonas von Andrian
...
! function(d, B, m, f) {
    ...
    q.prototype = {
        dragInit: function(a, b) {
            ...
            c.length && (this.item = c, this.itemContainer = b, !this.item.is(this.options.exclude) && this.options.onMousedown(this.item, n.onMousedown, a) && (this.setPointer(a), this.toggleListeners("on"), this.setupDelayTimer(),
                this.dragInitDone = !0));
        },
        drag: function(a) {
            if (!this.dragging) {
            ...
            (!b || b.top - c > a.top || b.bottom + c < a.top || b.left - c > a.left || b.right + c < a.left) && !this.searchValidTarget() &&
        ...
        searchValidTarget: function(a, b) {
            a ||
                (a = this.relativePointer || this.pointer, b = this.lastRelativePointer || this.lastPointer);
        ...
        $getOffsetParent: function() {
            if (this.offsetParent === f) {
                ...
                if (!this.options.rootGroup)
                    for (; a--;)
                        if (b[0] !=
                            this.containers[a].getItemOffsetParent()[0]) {
                            b = !1;
                            break
                        }
                this.offsetParent = b
        ...
        getPointer: function(a) {
            var b =
                a.originalEvent || a.originalEvent.touches && a.originalEvent.touches[0];
            return {
    ...
    t.prototype = {
        ...
        getItemDimensions: function() {
            this.itemDimensions || (this.items = this.$getChildren(this.el, "item").filter(":not(." + this.group.options.placeholderClass +
                ", ." + this.group.options.draggedClass + ")").get(), w(this.items, this.itemDimensions = [], this.options.tolerance));
        ...
        _serialize: function(a, b) {
            ...
            return this.rootGroup.options.serialize(a,
                e, b)
        },
        traverse: function(a) {
