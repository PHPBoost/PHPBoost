<script src="{PATH_TO_ROOT}/templates/__default__/plugins/accordion.js"></script>
...
<script src="{PATH_TO_ROOT}/templates/__default__/plugins/theia-sticky-sidebar.js"></script>
...
<script src="{PATH_TO_ROOT}/templates/__default__/plugins/bbcode-sidebar.js"></script>
