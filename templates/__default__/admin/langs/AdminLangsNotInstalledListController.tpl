							...
							<ul>
								...
								<li class="li-stretch">
									...
									<span>
										...
										# IF langs_not_installed.C_AUTHOR_EMAIL # <a href="mailto:{langs_not_installed.AUTHOR_EMAIL}" class="pinned bgc notice" aria-label="${LangLoader::get_message('email', 'user-common')}"><i class="fa iboost fa-iboost-email fa-fw" aria-hidden="true"></i></a># ENDIF #
										# IF langs_not_installed.C_AUTHOR_WEBSITE # <a href="{langs_not_installed.AUTHOR_WEBSITE}" class="pinned bgc question" aria-label="${LangLoader::get_message('index.site', 'main')}"><i class="fa fa-share-square fa-fw" aria-hidden="true"></i></a> # ENDIF #
									</span>
								</li>
							</ul>
						</div>
