				...
				<div class="cell-flex cell-tile cell-inline">
					# START shared_files #
						<div class="cell# IF shared_files.C_RECENT_FILE # new-content# ENDIF #">
							<span><span>{@upload.posted.by}</span># IF shared_files.C_AUTHOR_EXIST #<a class="{shared_files.AUTHOR_LEVEL_CLASS}"# IF shared_files.C_AUTHOR_GROUP_COLOR # style="color:{shared_files.AUTHOR_GROUP_COLOR}"# ENDIF # href="{shared_files.U_AUTHOR_PROFILE}">{shared_files.AUTHOR}</a># ELSE #${LangLoader::get_message('user.guest', 'user-lang')}# ENDIF #</span>
