<div class="menus-block-container# IF C_HORIZONTAL # menus-block-horizontal# ENDIF #" data-id="{IDMENU}" id="menu_{IDMENU}">
	# IF C_UP #<div class="menus-block-move menus-block-move-top"><a href="{U_UP}" aria-label="{L_MOVE_UP}"><i class="fa fa-chevron-up fa-lg"></i></a></div># ENDIF #
	...
	{CONTENTS}
	# IF C_DOWN #<div class="menus-block-move menus-block-move-bottom"><a href="{U_DOWN}" aria-label="{L_MOVE_DOWN}"><i class="fa fa-chevron-down fa-lg"aria-hidden="true"></i></a></div># ENDIF #
</div>
