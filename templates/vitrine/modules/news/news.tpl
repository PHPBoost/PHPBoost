        ...
        <div class="news_container">
            ...
            <div class="news_top">
                <div style="float:left;padding-left:30px;"><img class="valign_middle" src="../templates/{THEME}/images/icon.png" alt="Syndication" title="Syndication" />   <h3 class="title">{TITLE}</h3></div>
