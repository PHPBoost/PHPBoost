...
<div id="global">
	...
	# IF C_COMPTEUR #
	<div id="compteur">
		<span class="text_strong">{L_VISIT}:</span> {COMPTEUR_TOTAL} 	<span class="text_strong">|</span>     
	...
	<div class="bloc_container">
			<div class="bloc_top_l"></div>			
			<div class="bloc_top_r"></div>
			<div class="bloc_top"></div>
		# IF C_MENUS_TOPCENTRAL_CONTENT #
		<div class="bloc_content">
			{MENUS_TOPCENTRAL_CONTENT}
		</div>
		<div class="bloc_bottom_l"></div>		
			<div class="bloc_bottom_r"></div>
