...
<html lang="{L_XML_LANGUAGE}" >
	<head>
		...
		<link rel="stylesheet" href="{PATH_TO_ROOT}/kernel/css_cache.php?name=theme-{THEME}&amp;files=/templates/{THEME}/theme/design.css;/templates/{THEME}/theme/global.css;/templates/{THEME}/theme/content.css" type="text/css" media="screen, print, handheld" />
		# ELSE #
