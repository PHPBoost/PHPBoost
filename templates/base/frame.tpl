...
<html lang="{L_XML_LANGUAGE}"# IF C_OPENGRAPH # xmlns:og="http://ogp.me/ns#"# ENDIF #>
	<head>
		...
		<link rel="stylesheet" href="${CSSCacheManager::get_css_path('/templates/default/theme/default.css;/kernel/lib/css/font-awesome/css/fontawesome-all.css;/kernel/lib/css/font-awesome-animation/css/font-awesome-animation.css;/kernel/lib/js/lightcase/css/lightcase.css;/templates/{THEME}/theme/shape.css;/templates/{THEME}/theme/design.css;/templates/{THEME}/theme/content.css;/templates/{THEME}/theme/table.css;/templates/{THEME}/theme/form.css;/templates/{THEME}/theme/global.css;/templates/{THEME}/theme/cssmenu.css;/templates/{THEME}/theme/colors.css;/templates/{THEME}/theme/print.css')}" type="text/css" media="screen, print" />
		# ELSE #
		...
		<link rel="stylesheet" href="{PATH_TO_ROOT}/templates/{THEME}/theme/print.css" type="text/css" media="print" />
		# ENDIF #
