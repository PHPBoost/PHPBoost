		...
		<div id="admin_contents">
			...
			<table class="module_table">
				...
				<tr style="text-align:center;"> 
					...
					<td class="row2">
						<a href="admin_smileys.php?id={list.IDSMILEY}&amp;del=1&amptoken={TOKEN}" title="{L_DELETE}" onclick="javascript:return Confirm();"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/{LANG}/delete.png" alt="" /></a>
					</td>
				</tr>
