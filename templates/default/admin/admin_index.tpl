		...
		<div id="admin-contents">
			...
			<div class="content quick-access">
			...
			<div class="content elements-container columns-2">
				<div class="block dashboard-alerts">
					<div class="block-title">
				...
				<div class="block dashboard-advices">
					<div class="block-body">
						# INCLUDE ADVISES #
					</div>
				</div>

				<div class="block dashboard-user-online">
					<div class="block-title">
				...
				<div class="block dashboard-comments">
					<div class="block-title">
				...
				<div class="block dashboard-writting-pad">
