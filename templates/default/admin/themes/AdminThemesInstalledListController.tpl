...
<!--
	function select_themes(status)
	{
		...
		{
			if(status == "select" && i != {DEFAULT_THEME_NUMBER})
		...
		<div class="content elements-container columns-3">
			...
			<article id="installed-theme-element-{themes_installed.THEME_NUMBER}" class="block admin-element theme-element installed-element# IF themes_installed.C_IS_DEFAULT_THEME # default-element# ENDIF ## IF themes_installed.C_IS_ACTIVATED # activate-element# ELSE # deactivate-element# ENDIF #">
				<header>
					...
					# IF C_MORE_THAN_ONE_THEME_INSTALLED #
					<div id="delete-checkbox-{themes_installed.THEME_NUMBER}-container" class="form-field form-field-checkbox-mini admin-element-checkbox">
		...
		<footer>
			...
			<div class="select-all-container">
				...
				<div class="select-all-button-container">
					<button type="submit" name="delete-selected-themes" value="true" class="submit" id="select-all-button">{@themes.uninstall_all_selected_themes}</button>
				</div>
			</div>
			# ENDIF #
			...
			<fieldset class="fieldset-submit">
				...
				<button type="submit" class="submit" name="update_themes_configuration" value="true">${LangLoader::get_message('save', 'main')}</button>
