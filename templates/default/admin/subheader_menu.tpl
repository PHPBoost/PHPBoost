<nav class="cssmenu-admin">
	<ul>
		<li class="admin-li">
			...
			<div id="openmodal-{L_ADMINISTRATION}" class="cssmenu-modal">
				...
				<ul class="submenu">
					...
					<li>
						<a href="${relative_url(AdminMaintainUrlBuilder::maintain())}" title="{L_MAINTAIN}"><i class="far fa-fw fa-clock"></i>{L_MAINTAIN}</a>
					</li>
					<li>
		...
		<li class="admin-li">
			...
			<div id="openmodal-{L_USER}" class="cssmenu-modal">
				...
				<ul class="submenu">
					...
					<li>
						<a href="${relative_url(AdminExtendedFieldsUrlBuilder::fields_list())}" title="{L_EXTEND_FIELD}"><i class="fa fa-fw fa-list"></i>{L_EXTEND_FIELD}</a>
						<ul class="level-2">
		...
		<li class="admin-li">
			<a href="#openmodal-{L_CONTENT}" title="{L_CONTENT}"><i class="far fa-fw fa-square"></i><span>{L_CONTENT}</span></a>
			<div id="openmodal-{L_CONTENT}" class="cssmenu-modal">
				...
				<ul class="submenu">
					<li>
						<a href="${relative_url(AdminContentUrlBuilder::content_configuration())}" title="{L_CONTENT_CONFIG}"><i class="far fa-fw fa-square"></i>{L_CONTENT_CONFIG}</a>
					</li>
					<li>
						...
						<ul class="level-2">
							...
							<li><a href="{PATH_TO_ROOT}/admin/menus/content.php" title="{L_ADD_CONTENT_MENU}"><i class="far fa-fw fa-file"></i>{L_ADD_CONTENT_MENU}</a></li>
							<li><a href="{PATH_TO_ROOT}/admin/menus/feed.php" title="{L_ADD_FEED_MENU}"><i class="fa fa-fw fa-rss"></i>{L_ADD_FEED_MENU}</a></li>
						</ul>
					</li>
					<li>
						<a href="{PATH_TO_ROOT}/admin/admin_files.php" title="{L_FILES}"><i class="fa fa-fw fa-file-alt"></i>{L_FILES}</a>
						<ul class="level-2">
					...
					<li>
						<a href="${relative_url(UserUrlBuilder::comments())}" title="{L_COMMENTS}"><i class="far fa-fw fa-comment"></i>{L_COMMENTS}</a>
						<ul class="level-2">
					...
					<li>
						<a href="${relative_url(AdminSmileysUrlBuilder::management())}" title="{L_SMILEY}"><i class="far fa-fw fa-smile"></i>{L_SMILEY}</a>
						<ul class="level-2">
