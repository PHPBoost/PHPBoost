							...
							<table style="border:0;">
								<tr>
									...
									<td style="padding-top:8px;">	
										...
										{files.RENAME_FILE}
										<a href="admin_files.php?del={files.ID}&amp;f={FOLDER_ID}&amp;fm={USER_ID}&amp;token={TOKEN}" title="{L_DELETE}" class="delete"></a> 
