...
<html lang="{L_XML_LANGUAGE}">
	<head>
		...
		<link rel="stylesheet" href="${CSSCacheManager::get_css_path('/templates/default/theme/default.css;/kernel/lib/css/font-awesome/css/font-awesome.css;/templates/default/theme/admin_design.css;/templates/default/theme/admin_menus.css;/templates/default/theme/admin_content.css;/templates/default/theme/admin_table.css;/templates/default/theme/admin_global.css;/templates/default/theme/admin_cssmenu.css;/templates/default/theme/admin_form.css')}" type="text/css" media="screen, print" />
		# ELSE #
