<form action="{REWRITED_SCRIPT}" method="post">
	<table class="module_table" style="width:99%;margin-bottom:30px;">
		...
		# START langs_installed #
			<tr> 	
				<td class="row2" style="text-align:center; # IF langs_installed.C_IS_DEFAULT_LANG # background-color: #E1E1E1 # ENDIF #">					
					<span id="lang-{langs_installed.ID}"></span>
					<strong>{langs_installed.NAME}</strong> <em>({langs_installed.VERSION})</em>
				</td>
				<td class="row2" # IF langs_installed.C_IS_DEFAULT_LANG # style="background-color: #E1E1E1" # ENDIF #>
