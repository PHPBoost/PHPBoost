						...
						<ul>
							...
							<li class="li-stretch">
								...
								<span>
									...
									# IF langs_installed.C_AUTHOR_EMAIL # <a href="mailto:{langs_installed.AUTHOR_EMAIL}" class="pinned bgc notice" aria-label="${LangLoader::get_message('email', 'user-common')}"><i class="fa fa-mail-bulk fa-fw" aria-hidden="true"></i></a># ENDIF #
