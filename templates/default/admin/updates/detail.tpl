						...
						<tr>
							...
							<td class="valign-top">
								<div class="block-container">
									<div class="block-contents">
                                        <ul class="list">
                                            <li><a href="{U_APP_DOWNLOAD}"><i class="fa fa-cloud-download" aria-hidden="true"></i> {L_DOWNLOAD_PACK}</a></li>
                                            # IF U_APP_UPDATE #
											    <li><a href="{U_APP_UPDATE}"><i class="fa fa-refresh" aria-hidden="true"></i> {L_UPDATE_PACK}</a></li>
                                            # ENDIF #
    									</ul>
									</div>
								</div>
