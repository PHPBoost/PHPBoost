			...
			<table id="table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="center">
							<a href="{apps.download_url}"><i class="fa fa-cloud-download" aria-hidden="true" title="{L_DOWNLOAD_THE_COMPLETE_PACK}"></i> {L_DOWNLOAD_PACK}</a><br />
							# IF apps.update_url #
							/<br />
							<a href="{apps.update_url}"><i class="fa fa-refresh" aria-hidden="true" title="{L_DOWNLOAD_THE_UPDATE_PACK}"></i> {L_UPDATE_PACK}</a>
							# ENDIF #
						</td>
					</tr>
					# END apps #
