		<div id="admin_quick_menu">
			<ul>
				...
				<li>
					<a href="{MAIL_CONFIG_URL}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/admin/configuration.png" alt="" /></a>
					<br />
					<a href="{MAIL_CONFIG_URL}" class="quick_link">{L_MAIL_CONFIG}</a>
				</li>
			</ul>
		</div>
