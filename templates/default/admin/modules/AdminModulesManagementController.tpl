			...
			<tr>
				...
				<td>
					<div id="desc-explain-{modules_not_activated.ID}" class="left" style="display: none;">
						<span class="text-strong">{@modules.author} :</span> # IF modules_not_activated.C_AUTHOR_EMAIL #<a href="mailto:{modules_not_activated.AUTHOR_EMAIL}">{modules_not_activated.AUTHOR}</a># ELSE #{modules_not_activated.AUTHOR}# ENDIF # # IF modules_not_activated.C_AUTHOR_WEBSITE #<a href="{modules_not_activated.AUTHOR_WEBSITE}" class="basic-button smaller">Web</a># ENDIF #<br />
			...
			<tr>
				...
				<td>
					<div id="desc-explain-{modules_activated.ID}" class="left" style="display: none;">
						<span class="text-strong">{@modules.name} :</span> # IF modules_activated.C_AUTHOR_EMAIL #<a href="mailto:{modules_activated.AUTHOR_EMAIL}">{modules_activated.AUTHOR}</a># ELSE #{modules_activated.AUTHOR}# ENDIF # # IF modules_activated.C_AUTHOR_WEBSITE #<a href="{modules_activated.AUTHOR_WEBSITE}" class="basic-button smaller">Web</a># ENDIF #<br />
