...
<a href="javascript:MultipleFilePicker.add_file_input();" id="add_${escape(HTML_ID)}" class="input-file-more" title="${LangLoader::get_message('add', 'common')}"><i class="fas fa-plus"></i></a>
<script>
<!--
