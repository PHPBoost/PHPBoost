...
<a href="javascript:MultipleFilePicker.add_file_input();" id="add_${escape(HTML_ID)}" class="input-file-more" aria-label="${@add.files}"><i class="fa fa-plus" aria-hidden title="${@add.files}"></i></a>
<script>
<!--
