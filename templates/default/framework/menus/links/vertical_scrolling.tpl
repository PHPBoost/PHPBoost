# IF C_MENU # <!--  Menu -->
	...
	# IF C_NEXT_MENU # <!-- Children -->
		<li class="extend">
			# IF C_URL #<a href="{PATH_TO_ROOT}{RELATIVE_URL}"># IF C_IMG #<img src="{PATH_TO_ROOT}{RELATIVE_IMG}"/># ENDIF # # ELSE #<span># IF C_IMG #<img src="{ABSOLUTE_IMG}"/># ENDIF # # ENDIF #
		    {TITLE}
...
# ELSE # <!-- Simple Menu Link -->
    <li><a href="{PATH_TO_ROOT}{RELATIVE_URL}" title="{TITLE}"># IF C_IMG #<img src="{PATH_TO_ROOT}{RELATIVE_IMG}"/># ENDIF # {TITLE}</a></li>
# ENDIF #
