# IF C_MENU # <!--  Menu -->
			...
			<ul class="vertical-scrolling-menu">
				...
				# ENDIF #
					...
					# IF C_URL #<a href="{REL_URL}" title="{TITLE}"># ENDIF #
						# IF C_IMG #<img src="{REL_IMG}" class="valign-middle" alt="{TITLE}" height="{IMG_HEIGHT}" width="{IMG_WIDTH}" /> # ENDIF #
						{TITLE}
					# IF C_URL #</a> # ENDIF #
					</h5>
	...
	# IF C_NEXT_MENU # <!-- Children -->
		<li class="extend">
			# IF C_URL #<a href="{REL_URL}"># IF C_IMG #<img src="{REL_IMG}" alt="{TITLE}" height="{IMG_HEIGHT}" width="{IMG_WIDTH}" /># ENDIF # # ELSE #<span># IF C_IMG #<img src="{REL_IMG}" alt="{TITLE}" height="{IMG_HEIGHT}" width="{IMG_WIDTH}" /># ENDIF # # ENDIF #
			{TITLE}
