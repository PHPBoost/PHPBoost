...
<div class="calendar-container">
	<a id="{CALENDAR_ID}_link" href="" onclick="xmlhttprequest_calendar('{CALENDAR_ID}_date', ${escapejs(CALENDAR_ID)}, ${escapejs(YEAR)}, ${escapejs(MONTH)}, ${escapejs(DAY)}, ${escapejs(CALENDAR_NUMBER)}, 1);return false;" aria-label="{@form.date.selector}"><i class="fa fa-calendar" aria-hidden title="{@form.date.selector}"></i></a>
