...
<input type="text" size="11" maxlength="10" id="{CALENDAR_ID}" name="{CALENDAR_ID}" value="{DEFAULT_DATE}" placeholder="${LangLoader::get_message(Date::FORMAT_DAY_MONTH_YEAR_HOUR_MINUTE, 'date-common')}">
