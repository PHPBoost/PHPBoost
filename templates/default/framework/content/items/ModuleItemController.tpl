<section id="module-{MODULE_NAME}">
	<header>
		<div class="align-right controls">
			<a href="{U_SYNDICATION}" aria-label="${LangLoader::get_message('syndication', 'common')}"><i class="fa fa-rss warning" aria-hidden="true"></i></a> {MODULE_NAME}# IF NOT C_ROOT_CATEGORY # - {CATEGORY_NAME}# ENDIF #
	...
	# ENDIF #
	<article id="{MODULE_NAME}-item-{ID}" class="{MODULE_NAME}-item# IF C_NEW_CONTENT # new-content# ENDIF #" itemscope="itemscope" itemtype="http://schema.org/CreativeWork">
		<div class="flex-between">
			<div class="more">
				...
				# IF C_VIEWS_NUMBER_ENABLED #<span class="pinned" aria-label="{VIEWS_NUMBER} {@views}"><i class="fa fa-eye" aria-hidden="true"></i> {VIEWS_NUMBER}</span># ENDIF #
			</div>
			# IF C_CONTROLS #
