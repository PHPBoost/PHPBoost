	...
	# IF C_BBCODE_NORMAL_MODE #
		...
		var BBcodeEditor = Class.create(BBcodeEditor_Core,
		{
			...
			block1: [
				...
				{type:'separator'},
				{type:'action_prompt', fname:'url.png', label:${escapejs(L_BB_URL)}, tag: 'url', disabled:${escapejs(DISABLED_URL)}, prompt:${escapejs(L_URL_PROMPT)} },
				{type:'balise2', fname:'image.png', label:${escapejs(L_BB_IMAGE)}, tag: 'img', disabled:${escapejs(DISABLED_IMAGE)}},
