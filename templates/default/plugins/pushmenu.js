 ...
 * Plugin URL: https://github.com/somewebmedia/pushmenu
...
function _typeof(n) {
    return (_typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(n) {
        ...
        e = function(n, e, t) {
            console.warn("%cHC Off-canvas Nav:%c " + t + "%c '" + n + "'%c is now deprecated and will be removed. Use%c '" + e + "'%c instead.", "color: #BF263C", "color: default", "color: #4E8EC1", "color: default", "color: #366493", "color: default")
        },
        X = 0;
        _.fn.extend({
            pushmenu: function() {
             ...
             return this.each(function() {
                 ...
                 if (e.find("ul").addBack("ul").length) {
                     ...
                     var t, r, p, d = _("<nav>").on("click", G),
                         ...
                         x = {},
                         k = [];
                     H.customToggle ? s = _(H.customToggle).addClass("push-nav-trigger ".concat(b)).on("click", q) : (s = _('<a class="push-nav-trigger '.concat(b, '"><span></span></a>')).on("click", q), e.after(s));
                     var O = function() {
                             v.css("transition", "none"), g = v.outerWidth(), y = v.outerHeight(), l.add(".pushmenu.".concat(b, ".nav-position-left .nav-container"), "transform: translate3d(-".concat(g, "px, 0, 0)")), l.add(".pushmenu.".concat(b, ".nav-position-right .nav-container"), "transform: translate3d(".concat(g, "px, 0, 0)")), l.add(".pushmenu.".concat(b, ".nav-position-top .nav-container"), "transform: translate3d(0, -".concat(y, "px, 0)")), l.add(".pushmenu.".concat(b, ".nav-position-bottom .nav-container"), "transform: translate3d(0, ".concat(y, "px, 0)")), l.insert(), v.css("transition", ""), T()
                         },
                         T = function() {
                             var n;
                 ...
                 } else console.error("%c! HC Offcanvas Nav:%c Menu must contain <ul> element.", "color: #BF263C", "color: default");
                 ...
                 function N() {
                     if (h = !0, d.css("visibility", "visible").addClass($), s.addClass("toggle-open"), "expand" === H.levelOpen && C && clearTimeout(C), H.disableBody && (m = Q.scrollTop() || D.scrollTop(), L.documentElement.scrollHeight > L.documentElement.clientHeight && Q.addClass("push-nav-yscroll"), D.addClass("push-nav-open"), m && D.css("top", -m)), f) {
                 ...
                 function j() {
                     h = !1, f && R(f, 0), d.removeClass($), v.removeAttr("style"), s.removeClass("toggle-open"), "expand" === H.levelOpen && -1 !== ["top", "bottom"].indexOf(H.position) ? W(0) : !1 !== H.levelOpen && "none" !== H.levelOpen && (C = setTimeout(function() {
                         W(0)
                     }, "expand" === H.levelOpen ? r : 0)), H.disableBody && (D.removeClass("push-nav-open"), Q.removeClass("push-nav-yscroll"), m && (D.css("top", "").scrollTop(m), Q.scrollTop(m), m = 0)), setTimeout(function() {
