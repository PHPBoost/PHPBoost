					...
					<table class="module_table" style="width:100%">
						<tr>
							...
							<td class="forum_sous_cat" style="min-width:150px;">
								...
								<br />
								<span class="text_small">{forums_list.subcats.DESC}</span>
								<span class="text_small">{forums_list.subcats.SUBFORUMS}</span><br />
								<span class="text_small">[{L_TOPIC} :{forums_list.subcats.NBR_TOPIC} , 
								{L_MESSAGE}{forums_list.subcats.NBR_MSG}]</span>
							</td>
