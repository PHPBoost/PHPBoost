		...
		<div style="margin-top:20px;margin-bottom:20px;">
			<div class="module_position">					
				...
				<div class="module_top">
					<a href="syndication.php?idcat={IDCAT}" title="Rss">
					<img style="vertical-align:middle;margin-top:-2px;" src="../templates/{THEME}/images/rss.png" alt="Rss" title="Rss" /></a>
		...
		<div class="module_position">					
			...
			<div class="module_top">
				<span style="float:left;margin-left:15px">
					...
					{U_FORUM_CAT}<br />
					<a href="{U_POST_NEW_SUBJECT}">
					<img class="valign_middle" src="../templates/{THEME}/images/french/post.png" alt="post" title="poster" /></a>
				</span>
			...
			<div class="module_contents forum_contents">
				<table class="module_table" style="width:100%">
					...
					<tr>
						...
						# ENDIF #
						<td class="forum_sous_cat" style="width:25px;text-align:center;">
							<img src="{MODULE_DATA_PATH}/images/{topics.ANNOUNCE}.png" alt="Ann" />
						</td>
						...
						<td class="forum_sous_cat" style="min-width:115px;">
							{topics.ANCRE} <strong>{topics.TYPE}</strong> <a href="topic{topics.U_TOPIC_VARS}">{topics.L_DISPLAY_MSG} {topics.TITLE}</a> <em>[ {topics.AUTHOR} ]</em>
							<br />
							<span class="text_small">{topics.DESC}</span> &nbsp;<span class="pagin_forum">{topics.PAGINATION_TOPICS}</span><br />
								<span class="text_small">[ {L_VIEW} :{topics.VUS} , 
								{L_ANSWERS}:{topics.MSG} ]</span>
		...
		<div class="module_position">
			...
			<div class="module_bottom">
					<span style="float:left;margin-left:15px;margin-bottom:15px">
					<a href="{U_POST_NEW_SUBJECT}">
					<img class="valign_middle" src="../templates/{THEME}/images/french/post.png" alt="post" title="poster" /></a>
					<br /><br />
					{U_FORUM_CAT}<br /><br />
