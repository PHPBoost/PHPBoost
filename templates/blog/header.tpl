...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{L_XML_LANGUAGE}" >
	<head>
		...
		<link rel="stylesheet" href="{PATH_TO_ROOT}/templates/{THEME}/theme/dockstyle.css"  type="text/css" />
		...
		<script type="text/javascript" src="{PATH_TO_ROOT}/templates/{THEME}/theme/js/jquery.js"></script>
		<script type="text/javascript" src="{PATH_TO_ROOT}/templates/{THEME}/theme/js/interface.js"></script>
			<!--[if lt IE 7]>
	<style type="text/css">
