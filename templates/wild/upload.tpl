	...
	function rename_folder(id_folder, previous_name, previous_cut_name)
	{
		...
		{
			data = "id_folder=" + id_folder + "&name=" + name + "&previous_name=" + previous_name;
		...
		else if( name != '' )
		{
			...
			xhr_object.onreadystatechange = function() 
			{
				if( xhr_object.readyState == 4 && xhr_object.status == 200 ) 
				{
					...
					{
						document.getElementById('new_folder' + divid).innerHTML = '<table style="border:0"><tr><td style="width:34px;vertical-align:top;"><a href="upload.php?f=' + xhr_object.responseText + '&amp;{POPUP}"><img src="../templates/{THEME}/images/upload/folder_max.png" alt="" /></a></td><td style="padding-top:8px;"> <span id="f' + xhr_object.responseText + '"><a class="com" href="upload.php?f=' + xhr_object.responseText + '&amp;{POPUP}">' + name + '</a></span></span><div style="padding-top:5px;"><span id="fhref' + xhr_object.responseText + '"><span id="fihref' + xhr_object.responseText + '"><a href="javascript:display_rename_folder(\'' + xhr_object.responseText + '\', \'' + name.replace(/\'/g, "\\\'") + '\', \'' + name.replace(/\'/g, "\\\'") + '\');"><img src="../templates/{THEME}/images/{LANG}/edit.png" alt="" style="vertical-align:middle;" /></a></span></a></span> <a href="upload.php?delf=' + xhr_object.responseText + '&amp;f={FOLDER_ID}&amp;{POPUP}" onClick="javascript:return Confirm_folder();"><img src="../templates/{THEME}/images/{LANG}/delete.png" alt="" style="vertical-align:middle" /></a> <a href="upload.php?move=' + xhr_object.responseText + '&amp;{POPUP}" title="{L_MOVETO}"><img src="../templates/{THEME}/images/upload/move.png" alt="" style="vertical-align:middle;" /></a></div></td></tr></table>';
		...
		<tr> 
			<td class="row2">
				<span style="float:left;">
					...
					<br />					
					<a href="upload.php?fup={FOLDER_ID}&amp;{POPUP}"><img src="../templates/{THEME}/images/upload/folder_up.png" style="vertical-align:middle;" alt="" /></a>
						...
						<tr>
							...
							<td style="padding-top:8px;">						
								...
								<div style="padding-top:5px;">
									...
									<a href="upload{folder.U_MOVE}" title="{L_MOVETO}"><img src="../templates/{THEME}/images/upload/move.png" alt="" style="vertical-align:middle;" /></a>
					...
					<table style="border:0;">
						<tr>
							...
							<td style="padding-top:8px;">	
								...
								{files.RENAME_FILE}
								<a href="upload.php?del={files.ID}&amp;f={FOLDER_ID}&amp;{POPUP}" onClick="javascript:return Confirm_file();" title="{L_DELETE}"><img src="../templates/{THEME}/images/{LANG}/delete.png" alt="" style="vertical-align:middle;" /></a> 
								
								<a href="upload{files.U_MOVE}" title="{L_MOVETO}"><img src="../templates/{THEME}/images/upload/move.png" alt="" style="vertical-align:middle;" /></a>								
