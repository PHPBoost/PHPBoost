		...
		<div id="admin_contents">
			...
			<form action="admin_config.php" method="post" onsubmit="return check_form_conf();" class="fieldset_content">
				<fieldset> 
					...
					<dl>
						<dt><label for="site_lang">* {L_DEFAUT_LANGUAGES}</label></dt>
						<dd>
					...
					<dl>
						<dt><label for="default_theme">* {L_DEFAUT_THEME}</label></dt>
						<dd><label>
					...
					<dl>
						...
						<label>{L_OTHER} <input type="text" maxlength="255" size="20" id="start_page2" name="start_page2" class="text" /></label>
						</dd>
					</dl>
					<dl>
