		...
		<div id="admin_contents">
			...
			<div style="width:95%;margin:auto;">	
				...
				<div class="menu_tools group img_bg">
					<ul>
						<li>
						...
						<li>
							<a onclick="javascript:return Confirm_truncate_table()" style="color:red;background-image:url({PATH_TO_ROOT}/templates/{THEME}/images/upload/trash_mini.png)" href="admin_database_tools.php?table={TABLE_NAME}&amp;action=truncate">{L_TRUNCATE}</a>
						</li>
						<li>
							<a onclick="javascript:return Confirm_del_table()" style="color:red;background-image:url({PATH_TO_ROOT}/templates/{THEME}/images/{LANG}/delete.png)" href="admin_database_tools.php?table={TABLE_NAME}&amp;action=drop">{L_DELETE}</a>
						</li>
					</ul>
				</div>
			</div>
