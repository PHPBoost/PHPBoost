...
$LANG['db_explain_actions'] = 'This panel allows you to manage your database. You can see the list of tables used by PHPBoost, their properties. And also some tools which allows you to do basic operations in some tables. You can save your database too, or just save the tables you want, which you\'ll select here.
<br /><br />
<div class="question">The database optimization allows you to remake the table\'s structure to make easier the SQL server\'s operations. This operation is made automatically in each table once a day. You can optimize tables manually by this administration panel.
<br />
...
<br />
<strong>Be careful : </strong>It\'s a heavy operation, and it needs much resources. So it\'s advised not to repair tables when it\'s useless !</div>';
...
$LANG['import_file_explain'] = 'You can restore your database through a file in your computer. If your file exceed the maximum size allowed by your server (it\'s %s), you must do the alternative method, send your file in the folder <em>cache/backup</em> by FTP.';
