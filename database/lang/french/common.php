...
// Module titles
$lang['module.config.title'] = 'Configuration du module Base de données';

$lang['database.management'] = 'Gestion des tables';
$lang['database.sql.queries'] = 'Requêtes SQL';

// Configuration
$lang['database.config.tables.optimization.enabled'] = 'Activer l\'optimisation automatique des tables de la base de données';
$lang['database.config.tables.optimization.day'] = 'Jour de l\'optimisation';
$lang['database.config.tables.optimization.day.description'] = 'Optimisation exécutée dans la nuit';
...
$lang['database.action.for.selected.tables'] = 'Actions à réaliser sur la sélection de tables';
...
$lang['database.download'] = 'Télécharger';
...
// SQL queries
$lang['database.query.execute'] = 'Requête SQL';
$lang['database.tools'] = 'Gestion base de données';
...
';
$lang['database.submit.query'] = 'Exécuter';
$lang['database.query.result'] = 'Résultat';
$lang['database.executed.query'] = 'Requête SQL';
$lang['database.confirm.query'] = 'Voulez-vous vraiment exécuter la requête suivante : ';

// Restore files
$lang['database.file.list'] = 'Liste des fichiers';
$lang['database.restore.file.description'] = 'Cliquez sur le fichier que vous voulez restaurer.';
