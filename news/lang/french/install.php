...
$lang['items'][] = array(
    ...
    <ul class="formatter-ul">
        ...
        </li><li class="formatter-li"><a class="offload" href="' . AdminThemeUrlBuilder::list_installed_theme()->relative() . '">Choisissez le thème par défaut de votre site</a> pour en changer l\'apparence (vous pouvez en obtenir d\'autres sur le site de <a href="https://www.phpboost.com/download/">phpboost.com</a>).
