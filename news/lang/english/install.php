...
$lang['items'][] = array(
    ...
    <ul class="formatter-ul">
        ...
        </li><li class="formatter-li"><a class="offload" href="' . AdminThemeUrlBuilder::list_installed_theme()->relative() . '">Choose the website style</a> to change the look of your site (You can find more styles on the <a href="https://www.phpboost.com/download/">PHPBoost website</a> in the resources section.
