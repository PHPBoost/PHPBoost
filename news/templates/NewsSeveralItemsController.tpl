			...
			# START items #
				<article
					...
					<footer class="cell-footer">
						# IF items.C_HAS_UPDATE #<span class="pinned notice small text-italic modified-date">{@news.last.update} <time datetime="{items.UPDATE_DATE_ISO8601}" itemprop="dateModified">{items.UPDATE_DATE_FULL}</time></span># ENDIF #
						# IF items.C_SOURCES #
