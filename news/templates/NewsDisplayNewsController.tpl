		...
		<article itemscope="itemscope" itemtype="http://schema.org/CreativeWork" id="article-news-{ID}" class="article-news# IF C_NEW_CONTENT # new-content# ENDIF #">
			<header>
				...
				<div class="more">
					...
					<span class="more-element more-element-date">
						<i class="fas fa-calendar-alt"></i> <time datetime="# IF NOT C_DIFFERED #{DATE_ISO8601}# ELSE #{DIFFERED_START_DATE_ISO8601}# ENDIF #" itemprop="datePublished"># IF NOT C_DIFFERED #{DATE}# ELSE #{DIFFERED_START_DATE}# ENDIF #</time>
					</span> | 
					...
					# IF C_NB_VIEW_ENABLED # | <span title="{NUMBER_VIEW} {@news.view}" class="more-element more-element-view"><i class="fas fa-eye"></i> {NUMBER_VIEW}</span># ENDIF #
			...
			<aside>
				...
				<div id="news-sources-container">
					<span class="news-sources-title"><i class="fas fa-map-signs"></i> ${LangLoader::get_message('form.sources', 'common')}</span> :
					# START sources #
				...
				<div id="news-tags-container">
					<span class="news-tags-title"><i class="fas fa-tags"></i> ${LangLoader::get_message('form.keywords', 'common')}</span> :
						# START keywords #
				...
				# IF C_SUGGESTED_NEWS #
					<div id="news-suggested-container">
						<span class="news-suggested-title"><i class="far fa-lightbulb"></i> ${LangLoader::get_message('suggestions', 'common')} :</span>
						<ul>
							# START suggested #
				...
				<div class="navigation-link">
					...
					<span class="navigation-link-previous">
						<a href="{U_PREVIOUS_NEWS}"><i class="fas fa-arrow-circle-left"></i>{PREVIOUS_NEWS}</a>
					</span>
					# ENDIF #
					# IF C_NEXT_NEWS #
					<span class="navigation-link-next">
						<a href="{U_NEXT_NEWS}">{NEXT_NEWS}<i class="fas fa-arrow-circle-right"></i></a>
					</span>
					# ENDIF #
					<div class="spacer"></div>
				</div>
