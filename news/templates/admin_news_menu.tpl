<div id="admin_quick_menu">
	<ul>
		...
		<li>
			<a href="management.php?new=1"><img src="news.png" alt="" /></a>
			<br />
			<a href="management.php?new=1" class="quick_link">{L_ADD_NEWS}</a>
		</li>
		<li>
		...
		<li>
			<a href="admin_news_cat.php?new=1"><img src="news.png" alt="" /></a>
			<br />
			<a href="admin_news_cat.php?new=1" class="quick_link">{L_ADD_CAT}</a>
		</li>
		<li>
