		...
		<div class="news_container">
			...
			<div class="msg_top">
				<div style="float:left"><a href="rss.php" title="Rss"><img class="valign_middle" src="../templates/{THEME}/images/rss.png" alt="Rss" title="Rss" /></a> <h3 class="title valign_middle">{TITLE}</h3></div>
		...
		<div class="news_container">
			...
			<div class="msg_top_r"></div>
			<div class="msg_top">
				<a href="rss.php" title="Rss"><img class="valign_middle" src="../templates/{THEME}/images/rss.png" alt="Rss" title="Rss" /></a> <h3 class="title valign_middle">{L_LAST_NEWS}</h3>
			</div>	
			<div class="news_content">
		...
		<div class="news_container">
			...
			<div class="msg_top_r"></div>
			<div class="msg_top">
				<div style="float:left"><a href="rss.php" title="Rss"><img class="valign_middle" src="../templates/{THEME}/images/rss.png" alt="Rss" title="Rss" /></a> <a href="news{news.U_NEWS_LINK}" class="news_title">{news.TITLE}</a></div>
