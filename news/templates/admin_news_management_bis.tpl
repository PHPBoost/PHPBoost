			# START news #
					<label for="extend_contents">{L_EXTENDED_NEWS}</label></dt>
						...
						<dl class="overflow_visible">
							...
							<dd><label>
								<input type="text" size="8" maxlength="8" id="current_date" name="current_date" value="{news.CURRENT_DATE}" class="text" /> 			
						...
						<dl>
							...
							<dd>
								<label><input type="radio" value="1" name="archive" {news.ARCHIVE_ENABLED} /> {L_YES}</label>
								<label><input type="radio" value="0" name="archive" {news.ARCHIVE_DISABLED} id="archive" /> {L_NO}</label>
							</dd>
						</dl>
					</fieldset>	
