		...
		<article id="news-item-{ID}" class="news-item single-item# IF C_NEW_CONTENT # new-content# ENDIF #" itemscope="itemscope" itemtype="https://schema.org/CreativeWork">
			<div class="flex-between">
				<div class="more">
					...
					# IF C_VIEWS_NUMBER_ENABLED #<span class="pinned" role="contentinfo" aria-label="{VIEWS_NUMBER} # IF C_SEVERAL_VIEWS #{@views}# ELSE #{@view}# ENDIF #"><i class="fa fa-eye" aria-hidden="true"></i> {VIEWS_NUMBER}</span># ENDIF #
				</div>
				# IF C_CONTROLS #
					<div class="controls align-right">
						# IF C_EDIT #
