...
<br />
<br />
<p class="float_right">Toute l''équipe de PHPBoost vous remercie d''utiliser son logiciel pour créer votre site web!</p>', '', unix_timestamp(current_timestamp), 1, 0, 0, 1, '/templates/base/theme/images/phpboost3.jpg', 'PHPBoost 3.0', 0, 0);