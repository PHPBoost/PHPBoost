...
class News
{
	...
	public function get_real_short_contents()
	{
		...
		return TextHelper::mb_substr(@strip_tags(FormatingHelper::second_parse($this->contents), '<br><br/>'), 0, (int)NewsConfig::load()->get_number_character_to_cut());
	}
	...
	public function get_array_tpl_vars()
	{
		...
		return array_merge(
			...
			'C_READ_MORE' => !$this->get_short_contents_enabled() && $description != @strip_tags($contents, '<br><br/>') && TextHelper::strlen($description) > $news_config->get_number_character_to_cut(),
