...
class NewsCategoriesManageController extends AbstractCategoriesManageController
{
	...
	{
		return new AdminNewsDisplayResponse($view, StringVars::replace_vars(LangLoader::get_message('categories.page_title.management', 'categories-common'), array('module_name' => strtolower(LangLoader::get_message('news', 'common', 'news')))));
	}
