        ...
        <ul>
            ...
            <li class="has-sub fwk-builder">
                ...
                <ul>
                    ...
                    <li><a href="${relative_url(SandboxUrlBuilder::builder())}#Sandbox_Builder_miscellaneous" class="cssmenu-title"><span>{@hashtag.miscellaneous}</span></a></li>
            ...
            <li class="has-sub">
                ...
                <ul>
                    <li><a href="${relative_url(SandboxUrlBuilder::menus_nav())}" class="cssmenu-title"><span>{@hashtag.links}</span></a></li>
