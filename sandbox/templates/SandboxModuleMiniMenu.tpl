		...
		<div class="sbx-menu">
			...
			<div class="sbx-inset">
				<div class="sbx-menu-item sbx-text">
					...
					<div class="item-2x small" title="{@mini.viewport.h}">
						<span class="icon-stack">
			                ...
			                <i class="fas fa-arrows-alt-h icon-sup"></i>
			            </span>
					...
					<div class="item-2x small" title="{@mini.viewport.v}">
						<span class="icon-stack">
			                <i class="fas fa-tv icon-main"></i>
			                <i class="fas fa-arrows-alt-v icon-sup"></i>
			            </span>
						<span class="item-number">
				...
				<div class="sbx-menu-item">
					...
					<div class="item-2x# IF C_LOGGED_ERRORS # blink# ENDIF #" title="{@mini.errors}">
						<a href="${relative_url(AdminErrorsUrlBuilder::logged_errors())}">
							<span class="icon-stack">
				                <i class="fas fa-terminal icon-main"></i>
				                <i class="fa-pbt fa-warning icon-sup"></i>
				            </span>
							<span class="item-number">
								({ERRORS_NB})
							</span>
					...
					<div class="item-2x# IF C_404_ERRORS # blink# ENDIF #" title="{@mini.404}">
						<a href="${relative_url(AdminErrorsUrlBuilder::list_404_errors())}">
							<span class="icon-stack">
				                <i class="fas fa-unlink icon-main"></i>
				                <i class="fa-pbt fa-warning icon-sup"></i>
				            </span>
							<span class="item-number">
								({404_NB})
					...
					<div class="item-2x" title="{@mini.database}">
						<a href="{PATH_TO_ROOT}/database/admin_database.php">
							<span class="icon-stack">
				                <i class="fas fa-database icon-main"></i>
				                <i class="fas fa-cog icon-sup"></i>
				            </span>
						</a>
					</div>
					<div class="item-2x" title="{@mini.coms}">
						<a href="${relative_url(UserUrlBuilder::comments())}">
							<span class="icon-stack">
				                ...
				                <i class="fas fa-list icon-sup"></i>
				            </span>
							<span class="item-number">
								({COMMENTS_NB})
							</span>
				...
				<div class="sbx-menu-item">
					...
					<div class="item-3x" title="{@mini.menus}/{@mini.config}">
						<a href="{PATH_TO_ROOT}/admin/menus/menus.php">
							<span class="icon-stack">
				                <i class="fas fa-bars icon-main"></i>
				                <i class="fas fa-cog icon-sup"></i>
				            </span>
						</a>
					</div>
					...
					<div class="item-4x" title="{@mini.theme}/{@mini.manage}">
						<a href="${relative_url(AdminThemeUrlBuilder::list_installed_theme())}">
							<span class="icon-stack">
								<i class="fas fa-image icon-main"></i>
								<i class="fas fa-list icon-sup"></i>
							</span>
						</a>
					</div>
					...
					<div class="item-4x" title="{@mini.mod}/{@mini.manage}">
						<a href="${relative_url(AdminModulesUrlBuilder::list_installed_modules())}">
							<span class="icon-stack">
								<i class="fas fa-cube icon-main"></i>
								<i class="fas fa-list icon-sup"></i>
							</span>
						</a>
					</div>
					...
					<div class="item-4x" title="{@mini.config}/{@mini.advanced.config}">
						<a href="${relative_url(AdminConfigUrlBuilder::advanced_config())}">
							<span class="icon-stack">
								<i class="fas fa-university icon-main"></i>
								<i class="fas fa-cogs icon-sup"></i>
							</span>
						</a>
					</div>
				</div>
				<div class="sbx-menu-item">
					...
					<div class="item-3x"><a href="{PATH_TO_ROOT}/sandbox/bbcode" title="{@mini.sandbox.bbcode}"><i class="fas fa-code fa-2x"></i></a></div>
					<div class="item-3x"><a href="{PATH_TO_ROOT}/sandbox/menu" title="{@mini.sandbox.menu}"><i class="fas fa-bars fa-2x"></i></a></div>
					<div class="item-3x"><a href="{PATH_TO_ROOT}/sandbox/table" title="{@mini.sandbox.table}"><i class="fas fa-table fa-2x"></i></a></div>
					<div class="item-3x"><a href="${relative_url(SandboxUrlBuilder::config())}" title="{@mini.config}"><i class="fas fa-cogs fa-2x"></i></a></div>
				</div>
			</div>
		</div>
	</div>
