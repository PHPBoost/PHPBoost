<article id="fwkboost-pagination" class="sandbox-block">
    <header>
    ...
    &lt;ul> // class="light-pagination"
        ...
        &lt;/li>
        &lt;li class="pagination-item">
            &lt;a href="#" aria-label="{@fwkboost.pagination.page} 1">1&lt;/a>
        &lt;/li>
        &lt;li class="pagination-item">
            &lt;a href="#" class="current-page" aria-label="{@fwkboost.pagination.this}">2&lt;/a>
        &lt;/li>
        &lt;li class="pagination-item">
            &lt;a href="#" aria-label="{@fwkboost.pagination.page} 3">3&lt;/a>
        &lt;/li>
        &lt;li class="pagination-item">
            &lt;a href="#" rel="next" aria-label="{@fwkboost.pagination.next}" class="next-page">&lt;i class="fa fa-angle-right">&lt;/i>&lt;/a>
        &lt;/li>
    &lt;/ul>
&lt;/nav></code></pre>
        </div>
