	...
	private function build_table()
	{
		...
		foreach ($result as $row)
		{
			$results[] = new HTMLTableRow(array(
				...
				new HTMLTableRowCell(Date::to_format(!empty($row['last_connection_date'], Date::FORMAT_DAY_MONTH_YEAR_HOUR_MINUTE) ? $row['last_connection_date'] : $row['registration_date'])),
