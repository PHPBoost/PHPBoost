...
$accordion_form->set_css_class('<span style="color: #ff8800">accordion-container siblings</span> fieldset-content');
<br />
...
<br />
$fieldset_tab_one = new <span style="color: #ff8800">FormFieldsetMultitabsHTML</span>('<span style="color: #ff8800">targetID-01</span>', $this->lang['multitabs.panel.title'] . ' 01'<span style="color: #ff8800">, array('css_class' => 'accordion accordion-animation')</span>);
...
...
$fieldset_tab_two = new <span style="color: #ff8800">FormFieldsetMultitabsHTML</span>('targetID-02', $this->lang['multitabs.panel.title'] . ' 02'<span style="color: #ff8800">, array('css_class' => 'accordion accordion-animation')</span>);
$accordion_form->add_fieldset($fieldset_tab_two);
<em>// content of pannel 02</em>
...
$fieldset_tab_three = new <span style="color: #ff8800">FormFieldsetMultitabsHTML</span>('targetID-03', $this->lang['multitabs.panel.title'] . ' 03'<span style="color: #ff8800">, array('css_class' => 'accordion accordion-animation')</span>);
