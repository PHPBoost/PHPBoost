...
$lang['sandbox.layout.grid.clue']                      = '<p>There are three kind of cells grid (<code>.cell-flex</code>) layout: free cells (<code>.cell-inline</code>), mosaïc grid (<code>.cell-columns-{1 to 4}</code>) and list (<code>.cell-row</code>).</p>';
$lang['sandbox.layout.grid.free']                      = 'Free cells';
$lang['sandbox.layout.grid.free.clue']                 = 'Each cell is dependent on its own dimensions. Cells are horizontally aligned and automaticaly go to the next line when they exeed limits.';
$lang['sandbox.layout.grid.free.forced.clue']          = 'You can force width of undefined cells. <span class="pinned small">(for > 1024px screens)</span>';
$lang['sandbox.layout.grid.block.columns']             = 'Mosaïc grid';
$lang['sandbox.layout.grid.block.columns.clue']        = 'Width of cells are defined by the parent container.';
$lang['sandbox.layout.grid.block.columns.forced.clue'] = 'You can resize each cell even if it\'s define by the parent container. <span class="pinned small">(for > 1024px screens)</span>';
$lang['sandbox.layout.grid.list']                      = 'List';
$lang['sandbox.layout.grid.list.clue']                 = 'Whatever the width of cells, they are vertically aligned.';
$lang['sandbox.layout.grid.forced']                    = 'Forced cells';

// Cell
$lang['sandbox.layout.cell']          = 'Cells';
...
$lang['sandbox.layout.sandbox.table'] = 'Table';
