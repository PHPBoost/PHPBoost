...
$lang['layout.grid.clue']                      = '<p>There are three kind of cells grid layout: free cells, mosaïc grid and list.</p>';
$lang['layout.grid.free']                      = 'Free cells';
$lang['layout.grid.free.clue']                 = 'Each cell is dependent on its own dimensions. Cells are horizontally aligned and automaticaly go to the next line when they exeed limits.';
$lang['layout.grid.free.forced.clue']          = 'You can force width of undefined cells. <span class="pinned small">for > 1024px screens</span>';
$lang['layout.grid.block.columns']             = 'Mosaïc grid';
$lang['layout.grid.block.columns.clue']        = 'Width of cells are defined by the parent container.';
$lang['layout.grid.block.columns.forced.clue'] = 'You can resize each cell even if it\'s define by the parent container. <span class="pinned small">for > 1024px screens</span>';
$lang['layout.grid.list']                      = 'List';
$lang['layout.grid.list.clue']                 = 'Whatever the width of cells, they are vertically aligned.';
...
$lang['layout.sandbox.table'] = 'Table';
...
$lang['layout.sortables.description'] = '!! Movings are disabled !!';
