...
$lang['form.title.choices'] = 'Radio / checkbox';
$lang['form.title.select'] = 'Sélecteurs';
$lang['form.title.buttons'] = 'Boutons';
...
$lang['form.input.text.readonly'] = 'Champ en lecture seule';
...
$lang['form.input.fake.select'] = 'Liste déroulante avec images/icônes';
$lang['form.input.multiple.select'] = 'Liste déroulante multiple';
$lang['form.input.choice'] = 'Choix ';
$lang['form.input.choice.group'] = 'Groupe ';
