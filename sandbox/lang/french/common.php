...
<li><i class="fas fa-fw fa-asterisk"></i> Le rendu des différents champs utilisables avec le <a href="' . SandboxUrlBuilder::form()->absolute() . '" title="formulaires">constructeur de formulaires</a></li>
<li><i class="fas fa-fw fa-css3"></i> Le rendu des principales <a href="' . SandboxUrlBuilder::css()->absolute() . '" title="Classes CSS">classes CSS</a></li>
<li><i class="fas fa-fw fa-file-code-o"></i> Le rendu des styles spécifiques du <a href="' . SandboxUrlBuilder::bbcode()->absolute() . '" title="Styles BBCode">BBCode</a></li>
<li><i class="fas fa-fw fa-flag-o"></i> Un tutoriel sur l\'utilisation des icônes de la librairie <a href="' . SandboxUrlBuilder::icons()->absolute() . '" title="Icônes Font-Awesome">Font Awesome</a></li>
<li><i class="fas fa-fw fa-list"></i> Le rendu des <a href="' . SandboxUrlBuilder::menu()->absolute() . '" title="Menus de navigation">menus de navigation cssmenu</a></li>
<li><i class="fas fa-fw fa-table"></i> La génération de <a href="' . SandboxUrlBuilder::table()->absolute() . '" title="Tableaux">tableaux dynamiques</a></li>
<li><i class="fas fa-fw fa-at"></i> L\'<a href="' . SandboxUrlBuilder::mail()->absolute() . '" title="Emails">envoi d\'emails</a></li>
<li><i class="fas fa-fw fa-code"></i> La <a href="' . SandboxUrlBuilder::template()->absolute() . '" title="Génération de Thème">génération de template</a> avec ou sans cache</li>
</ul>
<br />
';
