...
$lang['builder.input.select.to.list'] = 'Liste déroulante avec images/icônes';
$lang['builder.input.multiple.select'] = 'Liste déroulante multiple';
$lang['builder.input.multiple.select.to.list'] = 'Liste déroulante multiple avec images/icônes';
