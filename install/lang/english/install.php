...
// Database
	...
	'dbms.parameters.paramters' => 'DBMS connection parameters',
	'dbms.parameters.host' => 'Database server hostname or DSN:',
	'dbms.parameters.host.explanation' => 'Database managing system server URL, often <em>localhost</em>',
    'dbms.parameters.port' => 'Database port',
    'dbms.parameters.port.explanation' => 'Database server port, <em>3306</em> most of the time.',
	'dbms.parameters.login' => 'Database username',
	'dbms.parameters.login.explanation' => 'Provided by your host',
	'dbms.parameters.password' => 'Database password',
	'dbms.parameters.password.explanation' => 'Provided by your host',
