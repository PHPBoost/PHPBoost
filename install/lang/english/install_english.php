...
<p>Before starting installation, be sure to have in hands Database informations provided by your hosting company. The installation is automatic and should take only a few minutes of your time.  To start the installation process, please click on the green arrow down below.</p>
<p>Best regards, the PHPBoost team</p>';
$LANG['intro_distribution'] = '%s distribution';
$LANG['intro_distribution_intro'] = '<p>There are serveral distributions which allow you to setup easily their website according to your needs. PHPBoost will install the kernel and modules according to the chosen distribution. After the installation is complete, you will be able to change settings and add/remove modules. </p>';
...
$LANG['gd_library_explain'] = 'Librairy used to generate pictures such as Robot Protection, Statistics Graphics and much more.';
$LANG['url_rewriting'] = 'URL Rewriting';
$LANG['url_rewriting_explain'] = 'Not only it rewrites URLs, but it helps a lot with search engine robots.';
...
$LANG['check_auth_dir'] = '<span style="font-weight:bold;color:red;">Required :</span> PHPBoost needs to change permissions of several directories to make them writables. If your hosting company allows it, it will be done automatically. However, you might need to do it by yourself to make the installation works. If you don\'t know how to change permissions of a directory, you can find help in our <a href="http://www.phpboost.net/wiki/change-the-chmod-of-a-directory" title="PHPBoost documentation : chmod">PHPBoost documentation</a> or on your host website.';
...
$LANG['db_explain'] = '<p>This step will generate a configuration file that contains the database settings and database tables will also be created at the same time. If you don\'t know your database settings, you might be able to find them in your host panel or need to ask them directly to your host support.</p>';
...
$LANG['db_prefix_explain'] = 'Default value is <em>phpboost_</em>. You will need to change this value if you want to install several times PHPBoost in the same database.';
...
$LANG['db_error_tables_already_exist'] = 'A PHPBoost installation has been found on this database with the prefix you entered. <span style="font-weight:bold;">If you proceed, all the datas in this database will be lost.</span>';
...
<p>If you proceed with the installation, all the datas in your database will bel ost. If you want to install another PHPBoost, you absolutely need to use another table prefix.</p>';
$LANG['already_installed_overwrite'] = 'Yes, I want to overwrite the existing datas and proceed with the installation.';
...
<p>You will be able to grant administrator rights to other members later. Here you just create the first administrator account, without which you couldn\'t manage your website.</p>';
...
$LANG['admin_password_explain'] = 'Enter a username between 6 and 30 characters in length';
...
$LANG['admin_passwords_error'] = 'The passwords you enteredµ¯n did not match.';
...
First of all, thank you to have powered your website with PHPBoost software, we hope you will be satisfied. For any problem ask your questions on the PHPBoost support forum : http://www.phpboost.org/forum/index.php
...
$LANG['end_installation'] = '<fieldset>
							...
							<p>Keep yourself informed about the evolution of PHPBoost by visting our website, <a href="http://www.phpboost.org">www.phpboost.org</a>. You will be warned in the administration panel when updates are available. We strongly recommand to keep your website up to date so you can take advantage of the latest features and correct any flaws or errors.</p>
							<p class="warning">For security reasons we also recommand you to delete the installation folder and all its contents, hackers could manage to run installation script and you could lose datas !</p>
						...
						<fieldset>
							...
							<p>Thanks to the members of our teams and particulary to <strong>Ptithom</strong> and <strong>Giliam</strong> for writing the french documentation, <strong>KONA</strong>, <strong>Frenchbulldog</strong>, <strong>Grenouille</strong>, <strong>EnimSay</strong>, <strong>swan</strong> for the templates, <strong>Gsgsd</strong>, <strong>Alain91</strong> and <strong>Crunchfamily</strong> for the modules development, <strong>PiJean</strong>, <strong>Forensic</strong> and <strong>Beowulf</strong> for the English translation and <strong>Shadow</strong> and <strong>Kak Miortvi Pengvin</strong> for the moderation of the community.</p>
