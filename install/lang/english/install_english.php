...
$LANG['end_installation'] = '<fieldset>
						...
						<fieldset>
							...
							<p>Thanks to the members of our teams and particulary to <strong>Ptithom</strong> and <strong>Giliam</strong> for writing the french documentation, <strong>KONA</strong>, <strong>Frenchbulldog</strong>, <strong>Grenouille</strong>, <strong>EnimSay</strong>, <strong>swan</strong> for the templates, <strong>Gsgsd</strong>, <strong>Alain91</strong> and <strong>Crunchfamily</strong> for the modules development, <strong>Beowulf</strong>, <strong>Forensic</strong>, <strong>JMNaylor</strong> and <strong>PiJean</strong> for the English translation and <strong>Shadow</strong> and <strong>Kak Miortvi Pengvin</strong> for the moderation of the community.</p>
