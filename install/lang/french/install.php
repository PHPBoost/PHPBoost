...
<p>En cas de problème n\'hésitez pas à poser vos questions sur le <a href="http://www.phpboost.com/forum/index.php">forum de support</a>.</p>',
	...
	'php.extensions.check.gd_library' => 'Librairie GD',
	'php.extensions.check.gd_library.explanation' => 'Librairie utilisée pour générer des images. Utile par exemple pour la protection anti robots, ou les diagrammes des statistiques du site. Certains modules peuvent également s\'en servir.',
	'server.url_rewriting' => 'URL Rewriting',
	'server.url_rewriting.explanation' => 'Réécriture des adresses des pages qui les rend plus lisibles et plus propices au référencement sur les moteurs de recherche',
	'auth_dir' => 'Autorisations des dossiers',
	'check_auth_dir' => '<span style="font-weight:bold;color:red;">Obligatoire :</span> PHPBoost nécessite que certains dossiers soient inscriptibles. Si votre serveur le permet, leurs autorisations sont changées de façon automatique. Cependant certains serveurs empêchent la modification automatique des autorisations, il faut donc faire la manipulation manuellement, pour cela voir la <a href="http://www.phpboost.com/wiki/changer-le-chmod-d-un-dossier" title="Documentation PHPBoost : Changer le chmod">documentation PHPBoost</a> ou contactez votre hébergeur.',
	'refresh_chmod' => 'Revérifier les dossiers',
	'existing' => 'Existant',
...
//Base de données
	'db_title' => 'Paramètres de connexion à la base de données',
	'db_explain' => '<p>Cette étape permet de générer le fichier de configuration qui retiendra les identifiants de connexion à votre base de données. Les tables permettant de faire fonctionner PHPBoost seront automatiquement créées lors de cette étape. Si vous ne connaissez pas les informations ci-dessous, contactez votre hébergeur qui vous les transmettra.</p>',
	'dbms_paramters' => 'Paramètres d\'accès au <acronym title="Système de Gestion de Base de Données">SGBD</acronym>',
	'db_host_name' => 'Nom de l\'hôte',
	'db_host_name_explain' => 'URL du serveur qui gère la base de données, <em>localhost</em> la plupart du temps.',
	'db_login' => 'Identifiant',
	'db_login_explain' => 'Fourni par l\'hébergeur',
	'db_password' => 'Mot de passe',
	'db_password_explain' => 'Fourni par l\'hébergeur',
	'db_properties' => 'Propriétés de la base de données',
	'db_name' => 'Nom de la base de données',
	'db_name_explain' => 'Fourni par l\'hébergeur. Si cette base n\'existe pas, PHPBoost essaiera de la créer si la configuration le lui permet.',
	'db_prefix' => 'Préfixe des tables',
	'db_prefix_explain' => 'Par défaut <em>phpboost_</em>. A changer si vous souhaitez installer plusieurs fois PHPBoost dans la même base de données.',
	...
	'field_database' => 'nom de la base de données',
	'db_error_connexion' => 'Impossible de se connecter à la base de données. Merci de vérifier vos paramètres.',
	'db_error_selection_not_creable' => 'La base de données que vous avez indiquée n\'existe pas et le système n\'a pas l\'autorisation de la créer.',
	'db_error_selection_but_created' => 'La base de données que vous avez indiquée n\'existait pas mais a pu être créée par le système.',
	'db_error_tables_already_exist' => 'Il existe déjà une installation de PHPBoost sur cette base de données avec ce préfixe. Si vous continuez, ces tables seront supprimées et vous perdrez certainement des données.',
	'db_success' => 'La connexion à la base de données a été effectuée avec succès. Vous pouvez poursuivre l\'installation',
	'db_unknown_error' => 'Une erreur inconnue a été rencontrée.',
	'require_hostname' => 'Vous devez renseigner le nom de l\'hôte !',
	'require_login' => 'Vous devez renseigner l\'identifiant de connexion !',
	'require_db_name' => 'Vous devez renseigner le nom de la base de données !',
	'db_result' => 'Résultats du test',
	'already_installed' => 'Installation existante',
	'already_installed_explain' => '<p>La base de données sur laquelle vous souhaitez installer PHPBoost contient déjà une installation de PHPBoost.</p>
<p>Si vous effectuez l\'installation sur cette base de données avec cette configuration, vous écraserez les données présentes actuellement. Si vous voulez installer deux fois PHPBoost sur la même base de données, utilisez des préfixes différents.</p>',
	'already_installed_overwrite' => 'Je souhaite écraser l\'installation de PHPBoost déjà existante',
...
//configuraton du site
	...
	'site_path_explain' => 'Vide si votre site est à la racine du serveur, de la forme /dossier sinon',
	'site_name' => 'Nom du site',
	'site_timezone' => 'Fuseau horaire du site',
	'site_timezone_explain' => 'La valeur par défaut est celle correspondant à la localisation de votre serveur. Pour la France, il s\'agit de GMT + 1. Vous pourrez changer cette valeur par la suite dans le panneau d\'administration.',
	'site_description' => 'Description du site',
	'site_description_explain' => '(facultatif) Utile pour le référencement dans les moteurs de recherche',
	'site_keywords' => 'Mots clés du site',
	'site_keywords_explain' => '(facultatif) A rentrer séparés par des virgules, ils servent au référencement dans les moteurs de recherche',
...
//administration
	...
	'admin_account_creation_explain' => '<p>Ce compte donne accès au panneau d\'administration par lequel vous configurerez votre site. Vous pourrez modifier les informations concernant ce compte par la suite en consultant votre profil.</p>
<p>Par la suite, il sera possible de donner à plusieurs personnes le statut d\'administrateur, ce compte est celui du premier administrateur, sans lequel vous ne pourriez pas gérer le site.</p>',
	...
	'admin_pseudo' => 'Pseudo',
	'admin_pseudo_explain' => 'Minimum 3 caractères',
	'admin_password' => 'Mot de passe',
	'admin_password_explain' => 'Minimum 6 caractères',
	'admin_password_repeat' => 'Répéter le mot de passe',
	'admin_mail' => 'Courrier électronique',
	'admin_mail_explain' => 'Doit être valide pour recevoir le code de déverrouillage',
	...
	'admin_create_session' => 'Me connecter à la fin de l\'installation',
	'admin_auto_connection' => 'Rester connecté systématiquement à chacune de mes visites',
	'admin_error' => 'Erreur',
	'admin_mail_object' => 'Identifiants de votre site créé avec PHPBoost (message à conserver)',
