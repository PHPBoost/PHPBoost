...
//Base de données
	...
	'dbms.parameters.paramters' => 'Paramètres d\'accès au <acronym title="Système de Gestion de Base de Données">SGBD</acronym>',
	'dbms.parameters.host' => 'Nom de l\'hôte',
	'dbms.parameters.host.explanation' => 'URL du serveur qui gère la base de données, <em>localhost</em> la plupart du temps.',
    'dbms.parameters.port' => 'Port du serveur',
    'dbms.parameters.port.explanation' => 'Port du serveur qui gère la base de données, <em>3306</em> la plupart du temps.',
	'dbms.parameters.login' => 'Identifiant',
	'dbms.parameters.login.explanation' => 'Fourni par l\'hébergeur',
	'dbms.parameters.password' => 'Mot de passe',
	'dbms.parameters.password.explanation' => 'Fourni par l\'hébergeur',
...
//configuraton du site
    ...
    'website.metaKeywords.explanation' => '(facultatif) Séparez chacun des mots par des virgules. Ils servent au référencement dans les moteurs de recherche',
