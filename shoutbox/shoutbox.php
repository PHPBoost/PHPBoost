...
else //Affichage.
{
	...
	while ($row = $Sql->fetch_assoc($result))
	{
		...
		{
			$edit_message = '&nbsp;&nbsp;<a href="../shoutbox/shoutbox' . url('.php?edit=1&id=' . $row['id']) . '"><img src="../templates/' . uget_theme() . '/images/' . uget_lang() . '/edit.png" alt="' . $LANG['edit'] . '" title="' . $LANG['edit'] . '" class="valign_middle" /></a>';
			$del_message = '&nbsp;&nbsp;<a href="../shoutbox/shoutbox' . url('.php?del=1&id=' . $row['id']) . '" onclick="javascript:return Confirm_shout();"><img src="../templates/' . uget_theme() . '/images/' . uget_lang() . '/delete.png" alt="' . $LANG['delete'] . '" title="' . $LANG['delete'] . '" class="valign_middle" /></a>';
		}
