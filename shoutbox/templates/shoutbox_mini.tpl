		...
		function XMLHttpRequest_shoutmsg()
		{
			...
			if( pseudo != '' && contents != '' )
			{
				...
				var xhr_object = xmlhttprequest_init('{PATH_TO_ROOT}/shoutbox/xmlhttprequest.php?token={TOKEN}&add=1&token={TOKEN}&display_date={C_HORIZONTAL}');
		...
		{
			document.getElementById('shoutimg').src = '{PATH_TO_ROOT}/templates/{THEME}/images/loading_mini.gif';
			var xhr_object = xmlhttprequest_init('{PATH_TO_ROOT}/shoutbox/xmlhttprequest.php?refresh=1&token={TOKEN}&display_date={C_HORIZONTAL}');
			xhr_object.onreadystatechange = function() 
			{
