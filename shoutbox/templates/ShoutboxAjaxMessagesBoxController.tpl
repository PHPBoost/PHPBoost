...
<div id="shoutbox-message-{messages.ID}" class="shoutbox-message-container">
	...
	<span class="shoutbox-message">
		...
		<a href="" onclick="shoutbox_delete_message({messages.ID});return false;" aria-label="${LangLoader::get_message('delete', 'common')}" id="delete_{messages.ID}"><i class="fa fa-remove" aria-hidden="true"></i></a># ENDIF #
