# START messages #
	<div id="shoutbox-message-{messages.ID}" class="shoutbox-message">
		...
		# IF messages.C_AUTHOR_EXISTS #
			<a href="{messages.U_AUTHOR_PROFILE}" class="shoutbox-message-author {messages.USER_LEVEL_CLASS} offload" # IF messages.C_USER_GROUP_COLOR # style="color:{messages.USER_GROUP_COLOR}" # ENDIF #>{messages.PSEUDO}</a>
		# ELSE #
