...
<div id="shoutbox-message-{messages.ID}" class="shoutbox-message-container">
	...
	<span class="shoutbox-message">
		...
		<a href="" onclick="shoutbox_delete_message({messages.ID});return false;" title="${LangLoader::get_message('delete', 'common')}" id="delete_{messages.ID}" class="fa-pbt fa-delete"></a># ENDIF #
