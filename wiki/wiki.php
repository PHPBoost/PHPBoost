...
//num�ro de l'article (utile pour les archives)
$id_contents = retrieve(GET, 'id_contents', 0);

$num_rows = 0;
$parse_redirection = false;

//Requ�tes pr�liminaires utiles par la suite
...
if ((!empty($encoded_title) || !empty($id_contents)) && $num_rows > 0)
{
	...
	if ($article_infos['is_cat'] == 1 && $id_contents == 0) //Cat�gorie non archiv�e
	{
		//On liste les articles de la cat�gorie et ses sous cat�gories
...
else
{
	...
	//Affichage de toutes les cat�gories si c'est activ�
