...
{ 
	...
	if( $article_infos['is_cat'] == 1 && $id_contents == 0 ) //Catégorie non archivée
	{
		...
		$Template->assign_block_vars('cat', array(
			'RSS' => $num_articles > 0 ? '<a href="syndication.php?cat=' . $article_infos['id_cat'] . '"><img src="../templates/' . uget_theme() . '/images/rss.png" alt="RSS" /></a>' : ''
		));
...
else
{
	if( $_WIKI_CONFIG['last_articles'] > 1 )
	{
		...
		$Template->assign_block_vars('last_articles', array(
			...
			'RSS' => $articles_number > 0 ? '<a href="syndication.php"><img src="../templates/' . uget_theme() . '/images/rss.png" alt="RSS" /></a>' : ''
		));
