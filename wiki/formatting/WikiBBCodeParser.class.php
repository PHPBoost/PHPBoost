 ...
 * It parses only the authorized tags (defined in the parent class which is ContentFormattingParser) and the wiki link tag.
 */
class WikiBBCodeParser extends BBCodeParser
{
	/**
	...
	/**
	 * @desc Parses the parser content from BBCode to XHTML, including the wiki link tag.
	...
	public function parse()
	{
		...
		$this->content = preg_replace('`\[link=([a-z0-9+#-_]+)\](.+)\[/link\]`isU', '[url=/wiki/$1]$2[/url]', $this->content);
