		<article>					
			...
			<div class="content">
				...
				# START cat #
					...
					# END IF #
					<br />
					<strong>{L_SUB_ARTICLES}</strong> &nbsp; <a href="${relative_url(SyndicationUrlBuilder::rss('wiki'))}" class="pbt-icon-syndication" title="${LangLoader::get_message('syndication', 'main')}"></a>
					<br /><br />
					# START cat.list_art #
