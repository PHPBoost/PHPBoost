			...
			<ul class="no-list">
				<li><a id="class-0" class="{CAT_0}" href="javascript:open_cat(0);"><i class="fa fa-folder"></i> {L_ROOT}</a>
					<ul>
						...
						<li class="sub">
							# IF list.U_FOLDER #
								<a class="parent" href="javascript:show_wiki_cat_contents({list.ID}, 0);"><i class="far fa-plus-square" id="img-subfolder-{list.ID}"></i><i id="img-folder-{list.ID}" class="fa fa-folder"></i></a>
