		<div class="wiki-tools-container">
			<nav id="cssmenu-wikitools" class="cssmenu cssmenu-right cssmenu-actionslinks cssmenu-tools">
				<ul class="level-0 hidden">
					# IF C_ACTIV_COM #
						<li>
							<a href="{U_COM}" class="cssmenu-title"><i class="fas fa-fw fa-comments-o"></i> {L_COM}</a>
						</li>
					# ENDIF #
					<li><a href="{U_HISTORY}" title="{L_HISTORY}" class="cssmenu-title">
						<i class="fas fa-fw fa-reply"></i> {L_HISTORY}
					</a></li>
					# IF C_INDEX_PAGE #
						# IF IS_ADMIN #
							<li><a href="{U_EDIT_INDEX}" title="{L_EDIT_INDEX}" class="cssmenu-title">
								<i class="fas fa-fw fa-edit"></i> {L_EDIT_INDEX}
							</a></li>
						# ENDIF #
					# ENDIF #
					# IF NOT C_INDEX_PAGE #
						...
						<li><a href="{U_EDIT}" title="{L_EDIT}" class="cssmenu-title">
							<i class="fas fa-fw fa-edit"></i> {L_EDIT}
						</a></li>
						# ENDIF #
						# IF C_DELETE #
