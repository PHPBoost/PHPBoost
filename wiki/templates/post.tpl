				...
				<div class="form-element">
					...
					<div class="explorer inline">
						<div class="cats">
							<div class="content">
								<ul>
									<li><a class="{CAT_0}" id="class-0" href="javascript:select_cat(0);"><i class="fas fa-folder"></i>{L_DO_NOT_SELECT_ANY_CAT}</a>
										<ul>
											# START create.list #
											<li class="sub">
												...
												<a class="parent" href="javascript:show_wiki_cat_contents({create.list.ID}, 1);" title="${LangLoader::get_message('display', 'common')}">
													<i class="far fa-plus-square" id="img-subfolder-{create.list.ID}"></i>
													<i class="fas fa-folder" id ="img-folder-{create.list.ID}"></i>
												</a>
												<a id="class-{create.list.ID}" href="javascript:select_cat({create.list.ID});">{create.list.TITLE}</a>
												# ELSE #
												<a id="class-{create.list.ID}" href="javascript:select_cat({create.list.ID});"><i class="fas fa-folder"></i>{create.list.TITLE}</a>
												# ENDIF #
