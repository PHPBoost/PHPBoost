...
if ($page_type == 'index')
{
	$other_tools[$LANG['wiki_rss']] = array(SyndicationUrlBuilder::rss('wiki'), 'rss');
}
if ($page_type == 'cat')
{
	$other_tools[$LANG['wiki_rss']] = array(SyndicationUrlBuilder::rss('wiki', $article_infos['id_cat']), 'rss');
}
//On parse
