...
$contents_preview = !empty($_POST['contents']) ? $_POST['contents'] : '';
...
{	
	...
	else //Si il n'a pas de catégorie parente
	{
		...
		FROM ".PREFIX."wiki_cats AS c
		LEFT JOIN ".PREFIX."wiki_articles AS a ON a.id = c.article_id
		WHERE c.id_parent = 0
...
$template->assign_var_from_handle('JS_TOOLS', 'post_js_tools');
