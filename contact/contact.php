...
include_once('../contact/lang/' . $CONFIG['lang'] . '/contact_' . $CONFIG['lang'] . '.php'); //Chargement de la langue du module.
...
$mail_contents = !empty($_POST['mail_contents']) ? $_POST['mail_contents'] : '';
