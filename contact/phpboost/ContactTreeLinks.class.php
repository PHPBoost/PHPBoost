...
class ContactTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$tree->add_link(new AdminModuleLink(LangLoader::get_message('contact.fields.management', 'common', 'contact'), ContactUrlBuilder::manage_fields()));
		$tree->add_link(new AdminModuleLink(LangLoader::get_message('fields.action.add_field', 'admin-user-common'), ContactUrlBuilder::add_field()));
