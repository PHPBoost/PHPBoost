...
<div id="input_fields_${escape(HTML_ID)}">
	...
	<div id="${escape(HTML_ID)}_{fieldelements.ID}" class="possible_values custom-radio">
		...
		<a href="javascript:ContactFormFieldObjectPossibleValues.delete({fieldelements.ID});" aria-label="${LangLoader::get_message('delete', 'common')}" data-confirmation="delete-element"><i class="fa fa-delete" aria-hidden="true"></i></a>
		<script>
		<!--
