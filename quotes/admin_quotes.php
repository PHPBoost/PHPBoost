...
{		
	$Template->set_filenames(array(
		'admin_quotes_config'=> 'quotes/admin_quotes.tpl'
	));
	
	$Cache->load('quotes');
	
	$array_auth = !empty($MODULES['quotes']['auth']) ? $MODULES['quotes']['auth'] : array();
	...
	$Template->assign_vars(array(
		...
		'L_RESET' => $LANG['reset'],
		'AUTH' => Authorizations::generate_select(ACCESS_MODULE, $array_auth, array(2 => true), 9, TRUE, TRUE)
	));
