...
// Classe ForumInterface qui hÈrite de la classe ModuleInterface
class QuotesInterface extends ModuleInterface
{
	...
	*/
	function get_cache()
	{
		...
		//RÈcupÈration du tableau linÈarisÈ dans la bdd.
	...
	*/
    ...
    /**
	*  @method  Renvoie la liste des arguments de la m√©thode <GetSearchRequest>
	*/
    ...
    /**
	*  @method  Renvoie la requ√™te de recherche dans le module
	*/
