						...
						<div class="fieldset-inset">
							<div class="form-element top-field">
								...
								<div class="form-field form-field-number">
									<input id="nb_results_p" type="number" min="1" max="200" name="nb_results_p" value="{NB_RESULTS_P}">
								</div>
							</div>
							<div class="form-element">
								...
								<div class="form-field form-field-select">
									<select id="authorized_modules[]" name="authorized_modules[]" size="10" multiple="multiple" class="list-modules">
										...
										<option id="{authorized_modules.MODULE}" value="{authorized_modules.MODULE}"{authorized_modules.SELECTED}>{authorized_modules.L_MODULE_NAME}</option>
						...
						<div class="fieldset-inset">
							<div class="form-element">
								<label for="cache_time">
									* {L_CACHE_TIME}
									<span class="field-description">{L_CACHE_TIME_EXPLAIN}</span>
								</label>
								<div class="form-field form-field-number">
							...
							<div class="form-element">
								<label for="max_use">
									* {L_MAX_USE}
									<span class="field-description">{L_MAX_USE_EXPLAIN}</span>
								</label>
								<div class="form-field form-field-number">
