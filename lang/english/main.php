...
$LANG['admin.subheader_menu'] = 'Main menu';
...
$LANG['open.all.panels'] = 'Open all panels';
$LANG['close.all.panels'] = 'Close all panels';
...
$LANG['select_all_messages'] = 'Select all messages';
