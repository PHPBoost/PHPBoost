...
$LANG['csrf_attack'] = '<p>You have potentially been the target of a <acronum title="Cross-Site Request Forgery">CSRF</acronym> attack which has been blocked by PHPBoost.</p>
