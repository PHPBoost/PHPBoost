...
$LANG['site_keyword_explain'] = '(Optional) You have to enter keywords separated by commas.';
...
$LANG['debug_explain'] = 'Display message in case of errors during include statements';
