...
$lang = array(
	...
	'advanced-config.redirection_www.with_www' => 'Redirect urls ' . AppContext::get_request()->get_site_domain_name() . ' to www.'. AppContext::get_request()->get_site_domain_name(),
	'advanced-config.redirection_www.without_www' => 'Redirect urls www.' . AppContext::get_request()->get_site_domain_name() . ' to '. AppContext::get_request()->get_site_domain_name(),
