...
$LANG['menus_explain'] = 'Le contenu des menus peut être rédigé en HTML ou en BBcode. Les deux peuvent également être mélangés.';
...
$LANG['db_confirm_delete_table'] = 'Etes-vous sur de vouloir supprimer cette table ?';
$LANG['db_confirm_truncate_table'] = 'Etes-vous sur de vouloir vider cette table ?';
