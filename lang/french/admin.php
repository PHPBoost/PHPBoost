...
$LANG['welcome_title'] = 'Bienvenue sur le tableau de bord d\'administration de votre site';
$LANG['welcome_desc'] = 'Ce tableau de bord vous permet de gérer le contenu et la configuration de votre site<br />La page d\'accueil recense les actions les plus courantes<br />Prenez le temps de lire les conseils afin d\'optimiser la sécurité de votre site';
...
$LANG['action.themes_management'] = 'Thèmes';
...
$LANG['curl_library'] = 'Extension Curl';
$LANG['mbstring_library'] = 'Extension Mbstring (UTF-8)';
...
$LANG['files_thumb'] = 'Afficher les miniatures dans le gestionnaire';
$LANG['files_thumb_explain'] = 'Pour les fichiers de type image';
...
$LANG['automatic.menu'] = 'Automatique';
$LANG['vertical.menu'] = 'Menu vertical déroulant';
$LANG['horizontal.menu'] = 'Menu horizontal déroulant';
$LANG['static.menu'] = 'Menu statique';
$LANG['push.menu'] = 'Menu poussé';
...
$LANG['theme_management'] = 'Gérer le thème';
$LANG['move'] = 'Déplacer';
$LANG['move_up'] = 'Monter';
...
$LANG['improvements'] = 'Améliorations';
$LANG['fixed_bugs'] = 'Corrections de bugs';
$LANG['security_improvements'] = 'Améliorations de sécurité';
