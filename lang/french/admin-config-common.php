...
$lang = array(
	...
	'advanced-config.hsts_security_enabled' => 'Activation la fonctionnalité HSTS',
	...
	'advanced-config.cookiebar-aboutcookie-title' => 'Titre de la page "<a href="' . UserUrlBuilder::aboutcookie()->absolute() . '">En savoir plus</a>"',
