...
$LANG['index.dashboard'] = 'Tableau de bord';
...
$LANG['post_com'] = 'Poster un commentaire';
...
$LANG['pm.status'] = 'Statut du message';
$LANG['read'] = 'Lu';
...
$LANG['user_readonly_explain'] = 'Membre en lecture seule, celui-ci peut lire mais ne peut plus poster sur la totalité du site (commentaires, etc.)';
$LANG['life'] = 'A vie';
...
//Footer
$LANG['powered_by'] = 'Humblement propulsé par';
$LANG['phpboost_right'] = '';
