...
$lang['config.display.summary.to.guests'] = 'Afficher le résumé des éléments aux visiteurs non autorisés en lecture';
...
$lang['config.characters.number.to.cut'] = 'Nombre de caractères pour couper l\'élément';
$lang['config.root_category_description'] = 'Description de la catégorie racine';
$lang['config.item.default.content'] = 'Contenu par défaut d\'un élément';
