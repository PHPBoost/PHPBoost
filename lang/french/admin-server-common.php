...
$lang['advises.disable_maintenance'] = '<a title="Désactivez la maintenance" href="' . AdminMaintainUrlBuilder::maintain()->rel() . '">Désactivez la maintenance</a> pour que les utilisateurs puissent afficher le site.';
