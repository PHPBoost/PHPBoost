...
class GalleryTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$tree->add_link(new AdminModuleLink($lang['gallery.manage'], GalleryUrlBuilder::manage()));
		$tree->add_link(new AdminModuleLink($lang['gallery.actions.add'], GalleryUrlBuilder::admin_add(AppContext::get_request()->get_getstring('id_category', 0))));
