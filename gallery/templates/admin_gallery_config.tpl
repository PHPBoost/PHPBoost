		...
		<fieldset>
			...
			<div class="fieldset-inset">
				...
				<div class="form-element">
					...
					<div class="form-field form-field-number"><input type="number" min="1" id="mini_max_height" name="mini_max_height" value="{MINI_MAX_HEIGHT}" /> </div>
				</div>
				<div class="form-element">
					<label for="mini_max_width">* {L_MINI_MAX_WIDTH} ({L_UNIT_PX})<span class="field-description">{L_MINI_MAX_WIDTH_EXPLAIN}</span></label>
					<div class="form-field form-field-number"><input type="number" min="1" id="mini_max_width" name="mini_max_width" value="{MINI_MAX_WIDTH}" /> </div>
				</div>
				<div class="form-element">
				...
				<div class="form-element">
					...
					<div class="form-field form-field-number"><input type="number" min="1" max="100" id="pics_number_per_page" name="pics_number_per_page" value="{PICS_NUMBER_PER_PAGE}" /></div>
				</div>
			</div>
		</fieldset>
		...
		<fieldset>
			...
			<div class="fieldset-inset">
				...
				<div class="form-element">
					...
					<div class="form-field form-field-number"><input type="number" min="1" name="pics_number_in_mini" id="pics_number_in_mini" value="{PICS_NUMBER_IN_MINI}"></div>
				</div>
				<div class="form-element">
		...
		<fieldset>
			...
			<div class="fieldset-inset">
				<div class="form-element">
					...
					<div class="form-field form-field-number"><input type="number" min="0" name="member_max_pics_number" id="member_max_pics_number" value="{MEMBER_MAX_PICS_NUMBER}"></div>
				</div>
				<div class="form-element">
					...
					<div class="form-field form-field-number"><input type="number" min="0" name="moderator_max_pics_number" id="moderator_max_pics_number" value="{MODERATOR_MAX_PICS_NUMBER}"></div>
				</div>
			</div>
		</fieldset>
