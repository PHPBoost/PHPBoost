	...
	<div class="gallery-tools-container">
		<nav id="cssmenu-galleryfilter" class="cssmenu cssmenu-right cssmenu-actionslinks cssmenu-tools">
			<ul class="level-0 hidden">
				...
				<li><a class="cssmenu-title"><i class="fa fa-sort" aria-hidden="true"></i> <span>{L_ORDER_BY}</span></a>
					<ul class="level-1">
				...
				<li><a class="cssmenu-title"><i class="fa fa-sort-alpha-down"></i> <span>{L_DIRECTION}</span></a>
					<ul class="level-1">
