			...
			else
			{
				...
				xhr_object.onreadystatechange = function() 
				{
					if( xhr_object.readyState == 4 && xhr_object.status == 200 && xhr_object.responseText != '0' )
					{
						...
						document.getElementById('fihref' + id_file).innerHTML = '<a href="javascript:display_rename_file(\'' + id_file + '\', \'' + html_protected_name + '\', \'' + html_protected_name2 + '\');" title="{L_EDIT}" class="edit"></a>';
						...
						<table class="module_table">
							...
							{cat.list.TR_START}								
								<td class="row2" style="vertical-align:bottom;text-align:center;width:{COLUMN_WIDTH_CATS}%">
									...
									<br />
									<a href="admin_gallery.php?cat={cat.list.IDCAT}">{cat.list.CAT}</a> <a href="admin_gallery_cat.php?id={cat.list.IDCAT}" title="{L_EDIT}" class="edit"></a> 
									<br />
									...
									<table style="border-collapse:collapse;margin:auto;width:100%" class="row2">
										...
										<tr>										
											<td colspan="2" class="row2 text_small" style="border:none;padding:4px;">
												&nbsp;&nbsp;&nbsp;<span id="fihref{pics.pics_max.ID}"><a href="javascript:display_rename_file('{pics.pics_max.ID}', '{pics.pics_max.RENAME}', '{pics.pics_max.RENAME_CUT}');" title="{L_EDIT}" class="edit"></a><
												
												<a href="gallery{pics.pics_max.U_DEL}" title="{L_DELETE}" class="delete"></a> 
									...
									<table style="border:0;margin:auto;">
										...
										<tr>
											<td style="text-align:center;">
												...
												<a href="admin_gallery.php?del={pics.list.ID}&amp;token={TOKEN}&amp;cat={CAT_ID}" title="{L_DELETE}" class="delete"></a>
