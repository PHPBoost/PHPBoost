...
$LANG['width_max_explain'] = '640px par défaut';
...
$LANG['comments_activated'] = 'Activer les Commentaires';
$LANG['comments_activated_explain'] = 'Commentaires sous la miniature';
$LANG['note_activated'] = 'Activer la notation';
$LANG['note_activated_explain'] = 'Moyenne des notes attribuées à la photo sous la miniature';
$LANG['display_nbr_note'] = 'Afficher le nombre de notes';
$LANG['note_max'] = 'Echelle de notation';
$LANG['note_max_explain'] = '5 par défaut';
$LANG['img_protect'] = 'Protection des images';
$LANG['logo_activated'] = 'Activer Logo';
$LANG['logo_activated_explain'] = 'Incrustation sur la photo';
$LANG['logo_url'] = 'Adresse du logo';
$LANG['logo_url_explain'] = 'Mettre dans le dossier /gallery';
$LANG['logo_transparency'] = 'Transparence du logo';
$LANG['logo_transparency_explain'] = '40% par defaut';
...
$LANG['explain_pics'] = 'La galerie que vous désirez supprimer contient <strong>%d</strong> images, voulez-vous les conserver en les transférants dans une autre galerie, ou bien tout supprimer?';
...
$LANG['explain_subgalleries'] = 'La galerie que vous désirez supprimer contient <strong>%d</strong> sous-galeries, voulez-vous les conserver en les transférants dans une autre galerie, ou bien les supprimer ainsi que leur contenu?';
