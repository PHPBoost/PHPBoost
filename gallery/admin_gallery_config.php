...
if (!empty($_POST['valid']))
{
	...
	$config_gallery['logo'] = TextHelper::strprotect(TextHelper::strprotect(AppContext::get_request()->get_poststring('logo', ''), TextHelper::HTML_PROTECT, TextHelper::ADDSLASHES_NONE));
