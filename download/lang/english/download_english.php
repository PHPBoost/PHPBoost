...
$DOWNLOAD_LANG['warning_previewing'] = 'Be careful, you see your file informations.As you don\'nt valid editions, they can\'t be applied.';
...
$DOWNLOAD_LANG['require_release_date'] = 'Please enter the release (or uptade) date in the right format (dd/mm/yy) !';
...
$DOWNLOAD_LANG['nbr_download_max'] = 'Maximum nunmber of file displayed per page';
$DOWNLOAD_LANG['nbr_columns_for_cats'] = 'Columns number who which present categories';
...
$DOWNLOAD_LANG['explain_icon_cat'] = 'You can choose a picture in the download/ folder or put its adress in the right field';
...
$DOWNLOAD_LANG['special_auth_explain'] = 'The category will have the module general configuration for default. You can apply particular permissions.';
...
//Erreurs
$DOWNLOAD_LANG['successful_operation'] = 'The operation that you have asked has been made successfully';
$DOWNLOAD_LANG['required_fields_empty'] = 'Whole requiered files are not be typed, please correctly remake the operation';
