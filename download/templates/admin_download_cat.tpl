		...
		<div id="admin_contents">
			...
			<form action="admin_download_cat.php" method="post">
							...
							<tr>	
								...
								<td class="row2"> 
									<select name="{cat.IDCAT}secure">
										# START cat.select_auth #	
											{cat.select_auth.RANK}
										# END cat.select_auth #
									</select>
								</td>						
								<td class="row2"> 
								...
								<td class="row2">
									<a href="admin_download_cat.php?del=1&amp;id={cat.IDCAT}" onClick="javascript:return Confirm();"><img src="../templates/{THEME}/images/{LANG}/delete.png" alt="{L_DELETE}" title="{L_DELETE}" /></a>
								</td>
							</tr>
							# END cat #
			...
			<form action="admin_download_cat.php" method="post" class="fieldset_content">
				<fieldset>
