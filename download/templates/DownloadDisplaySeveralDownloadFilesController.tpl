		...
		<div class="cell-flex cell-tile cell-columns-{CATEGORIES_PER_ROW}">
			...
			<div class="cell">
				<div class="cell-header">
					...
					<span class="small pinned notice" aria-label="{sub_categories_list.DOWNLOADFILES_NUMBER} # IF sub_categories_list.C_SEVERAL_ITEMS #${TextHelper::lcfirst(@files)}# ELSE #${TextHelper::lcfirst(@file)}# ENDIF #">
						...
						<div class="cell-body">
							...
							<div class="cell-content">
								...
								<div itemprop="text">
									...
									# ELSE #
										{downloadfiles.DESCRIPTION}# IF downloadfiles.C_READ_MORE #... <a href="{downloadfiles.U_ITEM}" class="read-more">[${LangLoader::get_message('read-more', 'common')}]</a># ENDIF #
									# ENDIF #
								</div>
							</div>
						</div>
