...
if ($edit_file_id > 0)
{
	...
	elseif ($preview)
	{
		...
		$Template->assign_vars(array(
			...
			'COUNT' => $file_hits,
			'DESCRIPTION' => htmlspecialchars(stripslashes($file_contents), ENT_COMPAT | ENT_HTML401, 'ISO-8859-1'),
			'SHORT_DESCRIPTION' => htmlspecialchars(stripslashes($file_short_contents), ENT_COMPAT | ENT_HTML401, 'ISO-8859-1'),
