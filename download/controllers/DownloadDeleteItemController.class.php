...
class DownloadDeleteItemController extends ModuleController
{
	private $item;
	...
	public function execute(HTTPRequestCustom $request)
	{
		...
		HooksService::execute_hook_action('delete', self::$module_id, $item->get_id(), $item->get_title(), $item->get_content(), $item->get_author_user());
