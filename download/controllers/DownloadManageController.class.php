...
class DownloadManageController extends AdminModuleController
{
	...
	{
		$display_categories = DownloadService::get_categories_manager()->get_categories_cache()->has_categories();
		...
		foreach ($result as $row)
		{
			...
			$edit_link = new LinkHTMLElement(DownloadUrlBuilder::edit($downloadfile->get_id()), '', array('title' => LangLoader::get_message('edit', 'common')), 'far fa-edit');
			$delete_link = new LinkHTMLElement(DownloadUrlBuilder::delete($downloadfile->get_id()), '', array('title' => LangLoader::get_message('delete', 'common'), 'data-confirmation' => 'delete-element'), 'far fa-delete');
