...
class DownloadFile
{
	...
	public function get_array_tpl_vars()
	{
		...
		return array_merge(
			...
			'C_READ_MORE' => !$this->is_short_contents_enabled() && $description != @strip_tags($contents, '<br><br/>') && TextHelper::strlen($contents) > DownloadConfig::NUMBER_CARACTERS_BEFORE_CUT,
