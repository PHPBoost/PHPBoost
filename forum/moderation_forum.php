...
if( !$Member->Check_level(1) && $check_auth_by_group !== true ) //Si il n'est pas modérateur (total ou partiel)
...
elseif( !empty($_GET['del_h']) && $Member->Get_attribute('level') === 2 ) //Suppression de l'historique.
{
