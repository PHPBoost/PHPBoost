		...
		# IF C_FORUM_SUB_CATS #
			<article itemscope="itemscope" itemtype="http://schema.org/Creativework" id="article-forum-subforum" class="forum-contents">
				<header>
					<h2>
						<a href="${relative_url(SyndicationUrlBuilder::rss('forum',IDCAT))}" class="fa-pbt fa-syndication" title="${LangLoader::get_message('syndication', 'common')}"></a>
				...
				<div class="content">
					<table id="table" class="forum-table">
						<thead>
							<tr>
								...
								<th class="forum-subject-nb"><i class="fas fa-comment fa-fw" title="{L_TOPIC}"></i></th>
								<th class="forum-message-nb"><i class="fas fa-comments fa-fw" title="{L_MESSAGE}"></i></th>
								<th class="forum-last-topic"><i class="fas fa-clock fa-fw" title="{L_LAST_MESSAGE}"></i></th>
							</tr>
						</thead>
						<tfoot>
							<tr>
					...
					# START subcats #
							<tr>
								...
								# ELSE #
								<td class="forum-announce-topic">
									<i class="fa-forum # IF subcats.C_BLINK #blink # ENDIF #{subcats.IMG_ANNOUNCE}"></i>
								</td>
								...
								<td class="forum-last-topic">
									# IF subcats.C_LAST_TOPIC_MSG #
										...
										<span class="last-topic-user"><i class="far fa-hand-point-right"></i><a href="{subcats.U_LAST_MSG}" title="" class="last-topic-date"></a> ${LangLoader::get_message('on', 'main')} {subcats.LAST_MSG_DATE_FULL}</span>
		...
		<article itemscope="itemscope" itemtype="http://schema.org/Creativework" id="article-forum-forum" class="forum-contents">
			<header>
				<h2>
					<a href="${relative_url(SyndicationUrlBuilder::rss('forum',IDCAT))}" class="fa-pbt fa-syndication" title="${LangLoader::get_message('syndication', 'common')}"></a> {U_FORUM_CAT}
					# IF C_POST_NEW_SUBJECT #
						<i class="fas fa-chevron-circle-right"></i> <a href="{U_POST_NEW_SUBJECT}" class="basic-button">{L_POST_NEW_SUBJECT}</a>
					# ENDIF #
					<span class="actions">
						# IF IDCAT #
						<a href="unread.php?cat={IDCAT}" title="{L_DISPLAY_UNREAD_MSG}"><i class="fa-forum fa-notread"></i></a>
						# ENDIF #
			...
			<div class="content">
				<table id="table2" class="forum-table">
					<thead>
						<tr>
							<th class="forum-announce-topic"><i class="fas fa-eye"></i></th>
							<th class="forum-fixed-topic"><i class="fas fa-check"></i></th>
							...
							<th class="forum-author"><i class="far fa-user fa-fw hidden-small-screens" title="{L_AUTHOR}"></i><span class="hidden-large-screens">{L_AUTHOR}</span></th>
							<th class="forum-message-nb"><i class="fas fa-comments fa-fw hidden-small-screens" title="{L_ANSWERS}"></i><span class="hidden-large-screens">{L_ANSWERS}</span></th>
							<th class="forum-view"><i class="fas fa-eye fa-fw hidden-small-screens" title="{L_VIEW}"></i><span class="hidden-large-screens">{L_VIEW}</span></th>
						...
						<tr>
							<th colspan="7">
								<div class="float-left">
									<a href="${relative_url(SyndicationUrlBuilder::rss('forum',IDCAT))}" title="${LangLoader::get_message('syndication', 'common')}"><i class="fa-pbt fa-syndication"></i></a> {U_FORUM_CAT}
									# IF C_POST_NEW_SUBJECT #
										<i class="fas fa-chevron-circle-right"></i> <a href="{U_POST_NEW_SUBJECT}" class="basic-button" title="{L_POST_NEW_SUBJECT}">{L_POST_NEW_SUBJECT}</a>
									# ENDIF #
								</div>
					...
					<tr>
						...
						<td class="forum-fixed-topic">
							# IF topics.C_DISPLAY_MSG #<i class="fa-forum fa-msg-display"></i># ENDIF #
							# IF topics.C_IMG_POLL #<i class="fas fa-tasks" title="{L_POLL}"></i># ENDIF #
							# IF topics.C_IMG_TRACK #<i class="fa-forum fa-msg-track"></i># ENDIF #
						</td>
						<td class="forum-topic">
						...
						<td class="forum-last-topic">
							<span class="last-topic-title"><i class="far fa-hand-point-right fa-fw"></i> <a href={topics.LAST_MSG_URL} title="{topics.TITLE}">{topics.LAST_MSG_DATE_FULL}</a></span>
							<span class="last-topic-user"> <i class="far fa-user fa-fw"></i>
