		...
		<article itemscope="itemscope" itemtype="http://schema.org/Creativework" id="article-forum-edit-message" class="forum-contents">
			<header>
				<h2>
					<a href="index.php" title="{L_FORUM_INDEX}">{L_FORUM_INDEX}</a> <i class="fas fa-chevron-circle-right"></i> {U_FORUM_CAT} <i class="fas fa-chevron-circle-right"></i> {U_TITLE_T} <span><em>{DESC}</em></span>
				</h2>
			</header>
			<div class="content">
