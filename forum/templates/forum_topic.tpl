		...
		<div class="msg_position" id="d{msg.ID}">
			...
			<div class="msg_sign{msg.CLASS_COLOR}">				
				...
				<span style="float:right;font-size:10px;">
					...
					{msg.USER_WARNING}%
					<a href="moderation_forum{msg.U_FORUM_WARNING}" title="{L_WARNING_MANAGEMENT}"><img src="{PATH_TO_ROOT}/templates/{THEME}/images/important_mini.png" alt="{L_WARNING_MANAGEMENT}" class="valign_middle" /></a>
