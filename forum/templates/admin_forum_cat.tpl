								...
								<div style="margin-left:{list.INDENT}px;">
									<div class="row3 forum_cat_admin">
										...
										<span style="float:right;">
											...
											<noscript><a href="admin_forum.php?id={list.ID}&amp;move=up"><img src="../templates/{THEME}/images/top.png" alt="" class="valign_middle" /></a></noscript>
											...
											<noscript><a href="admin_forum.php?id={list.ID}&amp;move=down"><img src="../templates/{THEME}/images/bottom.png" alt="" class="valign_middle" /></a></noscript>
											
											<a href="admin_forum.php?id={list.ID}"><img src="../templates/{THEME}/images/{LANG}/edit.png" alt="" class="valign_middle" /></a> <a href="admin_forum.php?del={list.ID}" onclick="javascript:return Confirm();"><img src="../templates/{THEME}/images/{LANG}/delete.png" alt="" class="valign_middle" /></a>&nbsp;&nbsp;
										</span>&nbsp;
									</div>	
								</div>
							</span>					
