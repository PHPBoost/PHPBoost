<div class="message">
		...
		<div class="message-user-infos">
			<div class="message-pseudo">
				<i class="fa fa-# IF C_USER_ONLINE #fa-user-check# ELSE #fa-user-times# ENDIF #" aria-hidden="true"></i> # IF C_USER_PSEUDO #<a href="{U_USER_PROFILE}">{USER_PSEUDO}</a><span class="sr-only"># IF C_USER_ONLINE #${LangLoader::get_message('forum.connected.mbr.yes', 'common', 'forum')}# ELSE #${LangLoader::get_message('forum.connected.mbr.no', 'common', 'forum')}# ENDIF #</span># ELSE #<span>${LangLoader::get_message('guest', 'main')}</span># ENDIF #
			</div>
