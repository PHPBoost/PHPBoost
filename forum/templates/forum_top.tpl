					...
					<div style="float:left;">
						...
						<div style="margin-top:4px;">
							# IF C_FORUM_CONNEXION #
								...
								# ENDIF #
								# IF C_USER_CONNECTED #
									<a class="small" href="?disconnect=true&amp;token={TOKEN}"><img src="{PATH_TO_ROOT}/templates/default/images/admin/home_mini.png" alt="" class="valign_middle" /> {L_DISCONNECT}</a> 
								# ENDIF # 						
							# ENDIF #
						</div>
					</div>
