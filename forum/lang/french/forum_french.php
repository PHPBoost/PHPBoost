...
$LANG['e.forum.nonexistent.topic'] = 'Le sujet que vous demandez n\'existe pas';
...
$LANG['explain_track'] = '
    Cocher la case <span class="text-strong">MP</span> (<i class="fa fa-people-arrows"></i>) pour recevoir un message privé,
    <span class="text-strong">E-mail</span> (<i class="fa iboost fa-iboost-email"></i>) pour un email, lors d\'une réponse au sujet suivi.
...
//SEO
$LANG['member_msg_seo'] = 'Tous les messages de :author.';
