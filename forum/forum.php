...
if( !$Member->Check_auth($CAT_FORUM[$id_get]['auth'], READ_CAT_FORUM) || !empty($CAT_FORUM[$id_get]['url']) )
...
if( !empty($id_get) )
{
	...
	$locked_cat = ($CAT_FORUM[$id_get]['status'] == 1 || $Member->Check_level(ADMIN_LEVEL)) ? false : true;
