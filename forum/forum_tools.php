...
$Template->put_all(array(
	'C_DISPLAY_UNREAD_DETAILS' => ($User->get_id() !== -1) ? true : false,
	'C_MODERATION_PANEL' => $User->check_level(1) ? true : false,
	'U_TOPIC_TRACK' => '<a class="small_link" href="../forum/track.php" title="' . $LANG['show_topic_track'] . '">' . $LANG['show_topic_track'] . '</a>',
	'U_LAST_MSG_READ' => '<a class="small_link" href="../forum/lastread.php" title="' . $LANG['show_last_read'] . '">' . $LANG['show_last_read'] . '</a>',
	'U_MSG_NOT_READ' => '<a class="small_link" href="../forum/unread.php" title="' . $LANG['show_not_reads'] . '">' . $LANG['show_not_reads'] . ($User->get_id() !== -1 ? ' (' . $nbr_msg_not_read . ')' : '') . '</a>',
