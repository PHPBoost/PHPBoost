...
$Bread_crumb->Add_link($LANG['show_last_read'], '');
...
if( $Member->Check_level(MEMBER_LEVEL) ) //Affichage des message()s non lu(s) du membre.
{
	...
	$Template->Assign_vars(array(
		...
		'PAGINATION' => $Pagination->Display_pagination('lastread' . transid('.php?p=%d'), $nbr_topics, 'p', $CONFIG_FORUM['pagination_topic'], 3),
		'LANG' => $CONFIG['lang'],
