<table id="table4">
	...
	<tfoot>
		<tr>
			<td colspan="2">
				<a href="{LINK_DELETE_DEFAULT}" title="${LangLoader::get_message('delete', 'common')}" data-confirmation="delete-element"><i class="far fa-delete"></i> {@labels.del_default_value}</a>
			</td>
		</tr>
	</tfoot>
	# ENDIF #
