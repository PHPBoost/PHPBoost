<nav id="cssmenu-bugtrackeractions" class="cssmenu cssmenu-group">
	<ul>
		# IF C_CHANGE_STATUS #
			<li><a href="{U_CHANGE_STATUS}" class="cssmenu-title"><i class="fa fa-fw fa-cogs" aria-hidden="true"></i><span>{@actions.change_status}</span></a></li>
		# ENDIF #
		<li><a href="{U_HISTORY}" class="cssmenu-title"><i class="fa fa-fw fa-history" aria-hidden="true"></i> <span>{@actions.history}</span></a></li>
		# IF C_EDIT_BUG #
			<li><a href="{U_EDIT}" aria-label="${LangLoader::get_message('edit', 'common')}" class="cssmenu-title cssmenu-title-icon"><i class="far fa-fw fa-edit" aria-hidden="true"></i></a></li>
		# ENDIF #
		# IF C_DELETE_BUG #
			<li><a href="{U_DELETE}" aria-label="${LangLoader::get_message('delete', 'common')}" class="cssmenu-title cssmenu-title-icon"><i class="far fa-fw fa-trash-alt" aria-hidden="true"></i></a></li>
		# ENDIF #
	</ul>
</nav>
<script>
...
# IF C_REPRODUCTION_METHOD #
	<fieldset>
		...
		<div class="fieldset-inset">{REPRODUCTION_METHOD}</div>
	</fieldset>
# ENDIF #
