...
$default_type = current($types);
$default_category = current($categories);
$default_version = current($versions);
...
if ( !empty($_POST['valid_add']) )
{
	...
	$detected_in = $display_versions ? retrieve(POST, 'detected_in', '') : $default_version['name'];
