 ...
 * @version     PHPBoost 5.3 - last update: 2018 05 24
...
class PagesHomePageExtensionPoint implements HomePageExtensionPoint
{
	...
	private function get_view()
	{
		...
		$config_authorizations = PagesConfig::load()->get_authorizations();
		...
		$num_coms = CommentsService::get_comments_number('pages');
