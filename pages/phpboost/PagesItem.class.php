...
class PagesItem extends RichItem
{
	protected function set_additional_attributes_list()
	{
		...
		$this->add_additional_attribute('author_display', array('type' => 'boolean', 'notnull' => 1, 'default' => 0, 'attribute_options_field_parameters' => array( // post content
	...
	public function set_author_display(bool $bool)
	{
		$this->set_additional_property('author_display', $author_display);
	}
