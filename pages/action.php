...
if( $id_page > 0 )
{
	...
	$speed_bar = array();
	if($id_redirection > 0 )
		$speed_bar[$LANG['pages_redirection_management']] = transid('action.php?id=' . $id_redirection);
	elseif( $id_new > 0 )
		$speed_bar[$LANG['pages_creation_redirection']] = transid('action.php?new=' . $id_redirection);
	elseif( $del_cat > 0 )
		$speed_bar[$LANG['pages_delete_cat']] = transid('action.php?del_cat=' . $id_redirection);
	else
		$speed_bar[$LANG['pages_rename']] = transid('action.php?rename=' . $id_rename);
	...
	$speed_bar = array($LANG['pages'] => transid('pages.php'), $LANG['pages_redirections'] => transid('action.php'));
