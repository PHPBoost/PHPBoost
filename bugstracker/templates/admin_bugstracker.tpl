...
<div id="admin_quick_menu">
	<ul>
		<li class="title_menu">{L_ADMIN_TITLE}</li>
		<li>
			<a href="admin_bugstracker.php"><img src="bugstracker.png" alt="" /></a>
			<br />
			<a href="admin_bugstacker.php" class="quick_link">{L_MENU_CONFIG}</a>
		</li>
	</ul>
</div>
...
<div id="admin_contents">
		...
		-->
			...
			<form name="form_update" action="admin_bugstracker.php" method="post" style="margin:auto;" onsubmit="return check_form_update(this);" class="fieldset_content">
				<fieldset>
...
function on_nature_changed(f)
{
		...
		<table class="module_table" style="width: 98%;">	
			...
			<tr>
				<td colspan="8" class="row1" style="text-align:center;">
					<form name="form_nature" method="post" action="admin_bugstracker.php">
	...
	<form name="form_edit" action="admin_bugstracker.php" method="post" style="margin:auto;" onsubmit="return check_form_edit(this);" class="fieldset_content">
