<div class="module_mini_container"# IF C_HORIZONTAL # style="width:auto;"# ENDIF #>
	...
	<div class="module_mini_contents">
		...
		<p class="smaller">{L_BY} # IF C_VISITOR #<span class="text_italic"># IF USER_PSEUDO #{USER_PSEUDO}# ELSE #{L_GUEST}# ENDIF #</span># ELSE #<a href="{U_PROFILE}" class="{USER_LEVEL_CLASS}" # IF C_USER_GROUP_COLOR # style="color:{USER_GROUP_COLOR}" # ENDIF #>{USER_PSEUDO}</a># ENDIF #</p>
		# ELSE #
