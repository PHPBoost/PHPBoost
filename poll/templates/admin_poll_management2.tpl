		...
		function add_field(i, i_max) 
		{
			...
			if( document.getElementById('s'+i) )
				document.getElementById('s'+i).innerHTML = (i < i_max) ? '<span id="s'+i2+'"><a href="javascript:add_field('+i2+', '+i_max+')"><img src="../templates/{THEME}/images/plus.png" alt="+" /></a></span>' : '';
		}
							...
							<table style="border:none;border-spacing:0">
								...
								<tr>
									<td style="text-align:center;" colspan="2">
										...
										<!--
											if( {MAX_ID} < 19 )
												document.write('<span id="s{MAX_ID}"><a href="javascript:add_field({MAX_ID}, 19)"><img src="../templates/{THEME}/images/plus.png" alt="+" /></a></span>');
										-->
										</script>
