							...
							<div class="form-field">
								<table class="table admin-poll">
									<tbody>
										...
										<tr>
											<td colspan="2">
												<span id="s3"><a href="javascript:add_field(3, 20)" aria-label="${LangLoader::get_message('add', 'common')}"><i class="fa fa-plus" aria-hidden="true" title="${LangLoader::get_message('add', 'common')}"></i></a></span>
											</td>
										</tr>
									</tbody>
								</table>
