			...
			<div class="module_position">					
				...
				<div class="module_contents">
					...
					<table class="module_table">
						...
						# END poll.question.radio #
					
						# START poll.question.checkbox #
						<tr>
							<td class="row2">
