		<table class="module_table">
			...
			<tr style="text-align:center;">
				<td style="width:25%;padding:15px;" class="row2">
		...
		<div class="module_table" style="width:50%; text-align:center;">			
			<div class="row2">
				<br />
				<a href="stats{select_month.U_PREVIOUS_MONTH}#stats">&laquo;</a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="stats{select_month.U_NEXT_MONTH}#stats">&raquo;</a>				
				<br /><br />
			</div>
		</div>
		</form>
		...
		<table class="module_table">
						...
						<tr>
							...
							<td style="height:200px;width:10px;vertical-align:bottom;">
								<table class="module_table" style="width:14px;margin:auto;">
									...
									# END head #
									<tr>
										<td style="margin-left:2px;width:10px;height:{month.days.HEIGHT}px;background-image: url(../templates/{THEME}/images/stats.png);background-repeat:repeat-y;padding:0px">
										</td>
									</tr>
								</table>
							</td>	
			...
			<tr>
				<td class="module_bottom" style="text-align:center;">
					{month.U_VISITS_YEAR}
				</td>
			</tr>
		</table>
		...
		<div class="module_table" style="width:50%; text-align:center;">			
			<div class="row2">
				<br />
				<a href="stats{select_year.U_PREVIOUS_YEAR}#stats">&laquo;</a>&nbsp;&nbsp;&nbsp;&nbsp;
				...
				&nbsp;&nbsp;&nbsp;&nbsp;
				<a href="stats{select_year.U_NEXT_YEAR}#stats">&raquo;</a>
				<br /><br />
			</div>
		</div>
		</form>
						...
						<tr>
							...
							<td style="height:200px;width:10px;vertical-align:bottom;">
								<table class="module_table" style="margin:auto;width:14px;">
									...
									<tr>
										<td style="margin-left:2px;width:10px;height:{year.months.HEIGHT}px;background-image: url(../templates/{THEME}/images/stats.png);background-repeat:repeat-y;padding:0px">
										</td>
									</tr>
								</table>						
							</td>	
					...
					<table class="module_table">
						...
						<tr style="height:35px;">
							...
							<td style="width:10px;text-align:center;" class="row2">			
								<div style="width:10px;height:10px;margin:auto;background:{browsers.browsers_list.COLOR};border:1px solid black;"></div>
							</td>
				...
				<td class="row2" style="width:50%;padding-top:30px;vertical-align:top">
					<table class="module_table">
						...
						<tr style="height:35px;">
							...
							<td style="width:10px; text-align:center;" class="row2">			
								<div style="width:10px;height:10px;margin:auto;background:{os.os_list.COLOR};border:1px solid black;"></div>
							</td>
							<td style="width:50px;" class="row2">
		...
		<table class="module_table">
				...
				<td class="row2" style="width:50%;padding-top:30px;vertical-align:top">
					<table class="module_table">
						...
						<tr style="height:35px;">
							...
							<td style="width:10px;text-align:center;" class="row2">			
								<div style="width:10px;margin:auto;height:10px;background:{lang.lang_list.COLOR};border:1px solid black;"></div>
							</td>
							<td style="width:50px;" class="row2">
			...
			<tr>
				<td class="module_bottom" colspan="3" style="text-align:center;">
					{L_LANG_ALL}
				</td>
			</tr>
		</table>
