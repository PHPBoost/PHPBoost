...
class ArticlesDisplayPendingArticlesController extends ModuleController
{
	...
	private function build_view($request)
	{
		...
		AND articles.id_category IN :authorized_categories' . (!ArticlesAuthorizationsService::check_authorizations()->moderation() ? ' AND articles.author_user_id = ' . AppContext::get_current_user()->get_id() : '') . '
