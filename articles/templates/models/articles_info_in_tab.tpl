...
<div class="module_position">
	...
	<div class="module_top">
		...
		<div style="float: right">
			# IF C_IS_ADMIN # &nbsp;&nbsp;<a href="{U_ARTICLES_EDIT}"
				title="{L_EDIT}"><img
				...
				class="valign_middle" alt="{L_DELETE}" /> </a> # ENDIF #
		</div>
	</div>
	# IF C_TAB #
	<div id="tabs">
	...
	<div class="module_contents">
			...
			<div id="tabContent{tab.ID_TAB}" class="tabContent"
				...
				<div style="float: right; top: 0px;">
					<table class="tab_extend_field">
						<tr>
							<th style="text-align: center;" colspan="2">{L_INFO}</th>
						</tr>
						# IF C_AUTHOR #
						<tr>
							<td class="row2 info_row"><span>{L_WRITTEN} </span>
							</td>
							<td class="row2"><span><a class="small_link"
									href="../member/member{U_USER_ID}">{PSEUDO}</a> </span>
							</td>
						</tr>
						# ENDIF # # IF C_DATE #
						<tr>
							<td class="row2 info_row"><span>{L_DATE} </span>
							</td>
							<td class="row2"><span> {DATE}</span>
							</td>
						</tr>
						# ENDIF # # IF C_SOURCES #
						<tr>
							<td class="row2 info_row"><span> {L_SOURCE} </span>
							</td>
							<td class="row2"><span># START sources # <a href="{sources.URL}">
										{sources.SOURCE}</a><br /> # END sources #</span>
							</td>
						</tr>
						# ENDIF # # IF C_COM #
						<tr>
							<td class="row2 info_row"><span>{L_COM} </span>
							</td>
							<td class="row2"><span>{COM}</span>
							</td>
						</tr>
						# ENDIF # # IF C_PRINT #
						<tr>
							<td class="row2 info_row"><span>{L_PRINTABLE_VERSION} </span>
							</td>
							<td class="row2"><span><a href="{U_PRINT_ARTICLE}"
									title="{L_PRINTABLE_VERSION}"><img
										src="../templates/{THEME}/images/print_mini.png"
										alt="{L_PRINTABLE_VERSION}" class="valign_middle" /> </a> </span>
							</td>
						</tr>
						# ENDIF # # IF C_MAIL #
						<tr>
							<td class="row2 info_row"><span>{L_LINK_MAIL} </span>
							</td>
							<td class="row2"><span><a href="javascript:display_mail()"><img
										src="../templates/{THEME}/images/pm_mini.png"
										class="valign_middle" alt="{L_LINK_MAIL}" /> </a> </span>
							</td>
						</tr>
						# ENDIF # # IF C_NOTE #
						<tr>
							<td class="row2" colspan="2" style="text-align: center;"><span>{KERNEL_NOTATION}</span>
							</td>
						</tr>
						# ENDIF #
					</table>
				</div>
				{tab.CONTENTS_TAB} {TEST}
			</div>
			# END tab #
		</div>
		<script type="text/javascript">
		...
		<div class="module_contents">
			...
			# ENDIF #
			<div>
				<div style="float: left; width: 65%">{CONTENTS}</div>
				<div style="float: right;">
					<table class="tab_extend_field">
						<tr>
							<th style="text-align: center;" colspan="2">{L_INFO}</th>
