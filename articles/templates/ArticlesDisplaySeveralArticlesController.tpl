					...
					<div class="cell-body">
						<div class="cell-infos">
							...
							<div class="controls">
								...
								<a href="{articles.U_DELETE_ARTICLE}" aria-label="${LangLoader::get_message('delete', 'common')}" data-confirmation="delete-element"><i class="fa fa-trash-alt" aria-hidden="true"></i></a>
								# ENDIF #
							</div>
						</div>
