...
$lang['root_category_description'] = '
	...
	<ul class="formatter-ul">
		<li class="formatter-li"> To configure or customize the module homepage your module, go into the <a href="' . ModulesUrlBuilder::configuration('articles')->relative() . '">module administration</a></li>
		...
		<li class="formatter-li"> To create articles, <a href="' . ItemsUrlBuilder::add(Category::ROOT_CATEGORY, 'articles')->relative() . '">clic here</a></li>
	</ul>
