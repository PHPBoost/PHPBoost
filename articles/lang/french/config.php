...
$lang['root_category_description'] = '
	...
	<ul class="formatter-ul">
		<li class="formatter-li"> Pour configurer ou personnaliser l\'accueil de votre module, rendez-vous dans l\'<a href="' . ModulesUrlBuilder::configuration('articles')->relative() . '">administration du module</a></li>
		...
		<li class="formatter-li"> Pour ajouter des articles, <a href="' . ItemsUrlBuilder::add(Category::ROOT_CATEGORY, 'articles')->relative() . '">cliquez ici</a></li>
	</ul>
