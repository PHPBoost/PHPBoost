...
class ArticlesSitemapExtensionPoint extends SitemapCategoriesModule
{
	...
	{
		parent::__construct(CategoriesService::get_categories_manager('articles'));
	}

	protected function get_category_url(Category $category)
	{
		return CategoriesUrlBuilder::display_category($category->get_id(), $category->get_rewrited_name(), 'articles');
	}
}
?>
