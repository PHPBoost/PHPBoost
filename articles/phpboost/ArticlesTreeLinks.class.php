...
class ArticlesTreeLinks implements ModuleTreeLinksExtensionPoint
{
	public function get_actions_tree_links()
	{
		...
		$manage_articles_link = new ModuleLink($lang['articles.management'], ArticlesUrlBuilder::manage_articles(), ArticlesAuthorizationsService::check_authorizations()->moderation());
		$manage_articles_link->add_sub_link(new ModuleLink($lang['articles.management'], ArticlesUrlBuilder::manage_articles(), ArticlesAuthorizationsService::check_authorizations()->moderation()));
		$manage_articles_link->add_sub_link(new ModuleLink($lang['articles.add.item'], ArticlesUrlBuilder::add_article(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ArticlesAuthorizationsService::check_authorizations()->moderation()));
		...
		{
			$tree->add_link(new ModuleLink($lang['articles.add.item'], ArticlesUrlBuilder::add_article(AppContext::get_request()->get_getint('id_category', Category::ROOT_CATEGORY)), ArticlesAuthorizationsService::check_authorizations()->write() || ArticlesAuthorizationsService::check_authorizations()->contribution()));
		}

		$tree->add_link(new ModuleLink($lang['articles.pending.items'], ArticlesUrlBuilder::display_pending_articles(), ArticlesAuthorizationsService::check_authorizations()->write() || ArticlesAuthorizationsService::check_authorizations()->contribution() || ArticlesAuthorizationsService::check_authorizations()->moderation()));
