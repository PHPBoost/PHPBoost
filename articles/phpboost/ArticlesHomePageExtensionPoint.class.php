...
class ArticlesHomePageExtensionPoint implements HomePageExtensionPoint
{
	...
	private function get_view()
	{
		...
		$tpl->put_all(array(
			...
			'U_ADD' => url('/articles/management.php?new=1&amp;cat=' . $idartcat),
			'U_EDIT'=> url('/articles/admin_articles_cat.php?edit='.$idartcat),
			'U_ARTICLES_WAITING'=> '/articles/articles.php?invisible=1&amp;cat='.$idartcat,
