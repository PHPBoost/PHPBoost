...
INSERT INTO phpboost_articles_cats (`id`, `id_parent`, `c_order`, `name`, `description`, `nbr_articles_visible`, `nbr_articles_unvisible`, `image`, `visible`, `auth`) VALUES ('1', '0', '2', 'Catégorie de test', '', '0', '0', '../articles/articles.png', '1', '');
