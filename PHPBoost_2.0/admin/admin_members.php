	...
	{	
		...
		else
		{
			...
			{	
				...
				$sql->query_inject("UPDATE ".PREFIX."member SET login = '" . $login . "', level = '" . $user_level . "', user_groups = '" . $user_groups . "', user_lang = '" . $user_lang . "', user_theme = '" . $user_theme . "', user_mail = '" . $user_mail . "', user_show_mail = '" . $user_show_mail . "', user_local = '" . $user_local . "', " . $user_avatar . "user_msn = '" . $user_msn . "', user_yahoo = '" . $user_yahoo . "', user_web = '" . $user_web . "', user_occupation = '" . $user_occupation . "', user_hobbies = '" . $user_hobbies . "', user_desc = '" . parse($user_desc) . "', user_sex = '" . $user_sex . "', user_born = '" . $user_born . "', user_sign = '" . parse($user_sign) . "', user_warning = '" . $user_warning . "', user_readonly = '" . $user_readonly . "', user_ban = '" . $user_ban . "', user_aprob = '" . $user_aprob . "' WHERE user_id = '" . $id_post . "'", __LINE__, __FILE__);
...
{		
	...
	if( $extend_field_exist > 0 )
	{
		...
		LEFT JOIN ".PREFIX."member_extend AS ex ON ex.user_id = '" . $id . "'
		WHERE exc.display = 1
...
{			
	...
	$template->assign_vars(array(
		'PAGINATION' => $pagination->show_pagin('admin_members.php?p=%d' . $unget, $nbr_membre, 'p', 25, 3),	
		'THEME' => $CONFIG['theme'],
		'LANG' => $CONFIG['lang'],
		'L_REQUIRE_MAIL' => $LANG['require_mail'],
