...
if (!empty($_POST['valid']))
{
	...
	$config_online['online_refresh_frequency'] = retrieve(POST, 'online_refresh_frequency', 15);
	if ($config_online['online_refresh_frequency'] < 15)
		$config_online['online_refresh_frequency'] = 15;
...
{		
	...
	$Template->assign_vars(array(
		...
		'REFRESH_FREQUENCY' => !empty($CONFIG_ONLINE['online_refresh_frequency']) ? $CONFIG_ONLINE['online_refresh_frequency'] : 15,
		'L_ONLINE_CONFIG' => $LANG['online_config'],
		'L_NBR_ONLINE_DISPLAYED' => $LANG['nbr_online_displayed'],
		'L_REFRESH_FREQUENCY' => $LANG['online_refresh_frequency'],
