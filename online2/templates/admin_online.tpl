		...
		<div id="admin_contents">
			<form action="admin_online.php?token={TOKEN}" method="post" class="fieldset_content">
				<fieldset>
					...
					<dl>
						<dt><label for="online_refresh_frequency">* {L_REFRESH_FREQUENCY}</label></dt>
						<dd><label><input type="text" maxlength="3" size="3" name="online_refresh_frequency" id="online_refresh_frequency" value="{REFRESH_FREQUENCY}" class="text" /></label></dd>
					</dl>
				</fieldset>	
